...
class Acf_Flexible_Content extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
		...
		$this->add_control(
			'flexible_field',
			[
				'label' => __( 'Select ACF Flexible Content Field', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
				'object_type' => 'flexible_content',
				'dynamic' => [
					'active' => false,
				],
			]
		...
		$repeater_layout->add_control(
		'layout',
			[
				'type' => 'ooo_query',
				'label' => __( 'Layout', 'dynamic-content-for-elementor' ),
				'placeholder' => __( 'Select the layout', 'dynamic-content-for-elementor' ),
				'query_type' => 'acf_flexible_content_layouts',
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'layouts', [
				'label' => __( 'Show these layouts', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_layout->get_controls(),
				'title_field' => '{{{layout}}}',
				'prevent_empty' => false,
				'item_actions' => [
					'add' => true,
