...
class DCE_Widget_DynamicUsers extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
		...
		$this->add_control(
				'author_user', [
					'label' => __( 'Show only the author of the current post', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'metaFilter',
				[
					'label' => __( 'User Field Filter', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Field key or Name', 'dynamic-content-for-elementor' ),
					'query_type' => 'fields',
					'dynamic' => [
		...
		$this->add_control(
				'metaValue_filter', [
					'label' => __( 'Meta value', 'dynamic-content-for-elementor' ),
					'description' => __( 'The value of the filter. Use comma as separator for multiple values', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'exclude_user',
				[
					'label' => __( 'Exclude selected users', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
		...
		$this->add_control(
				'exclude_author_post', [
					'label' => __( 'Exclude users without articles', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'author_user' => '',
					],
		...
		$repeater->add_control(
				'meta', [
					...
					'options' => [
						...
						'articles' => __( 'Posts', 'dynamic-content-for-elementor' ),
		...
		$repeater->add_control(
				'attachment_url', [
					'label' => __( 'Add Link to Attachment', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'meta' => 'attachments',
					],
		...
		$repeater->add_control(
				'articles_url', [
					'label' => __( 'Add Link to Post', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'meta' => 'articles',
					],
		...
		$repeater->add_group_control(
				Group_Control_Typography::get_type(), [
					...
					'label' => __( 'Typography item', 'dynamic-content-for-elementor' ),
		...
		$repeater->add_responsive_control(
				'flexgrid_mode_attachments', [
					...
					'mobile_default' => '1',
					'options' => [
						'flex-start' => __( 'Flex start', 'dynamic-content-for-elementor' ),
						'flex-end' => __( 'Flex end', 'dynamic-content-for-elementor' ),
						'center' => __( 'Center', 'dynamic-content-for-elementor' ),
						'space-between' => __( 'Space Between', 'dynamic-content-for-elementor' ),
						'space-around' => __( 'Space Around', 'dynamic-content-for-elementor' ),
					],
					'selectors' => [
		...
		$this->add_control(
				'posts_style', [
					...
					'options' => [
						...
						'flexgrid' => __( 'Grid', 'dynamic-content-for-elementor' ),
						'grid' => __( 'Masonry', 'dynamic-content-for-elementor' ),
					],
				]
		);
		$this->add_responsive_control(
				'columns_grid_flex', [
					...
					'selectors' => [
						...
						'{{WRAPPER}} .dce-grid-users.grid .dce-item-user' => 'width: calc( 100% / {{VALUE}} ); display: inline-block;',
					],
					'condition' => [
		...
		$this->add_responsive_control(
				'filters_padding_items', [
					'label' => __( 'Space between filters', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'default' => [
						'size' => 5,
						'unit' => 'px',
		...
		$this->add_responsive_control(
			'pagination_align', [
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .dce-pagination' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		$userargs = array(
			...
			'number' => $settings['results_per_page'],
		);
