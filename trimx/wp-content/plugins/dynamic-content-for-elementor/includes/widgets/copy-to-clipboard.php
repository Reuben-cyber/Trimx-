	...
	protected function _register_controls_content() {
		...
		$this->add_control(
				...
				[
					...
					'placeholder' => __( 'Copy to Clipboard', 'dynamic-content-for-elementor' ),
				]
		);
		...
		$this->add_control(
				'animation_on_copy',
				[
					'label' => __( 'Animation on copy', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'change-text' => __( 'Change Text', 'dynamic-content-for-elementor' ),
						'shake-animation' => __( 'Shake Animation', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'change_text',
				[
					'label' => __( 'Change text to', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'default' => __( 'Copied', 'dynamic-content-for-elementor' ),
					'condition' => [
						'animation_on_copy' => 'change-text',
					],
				]
		);
		...
		$this->add_control(
				'button_css_id',
				[
					'label' => __( 'Button ID', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'dynamic' => [
						'active' => true,
					],
					'default' => '',
					'title' => __( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'dynamic-content-for-elementor' ),
					'label_block' => false,
					'description' => __( 'Please make sure the ID is unique and not used elsewhere on the page where this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'dynamic-content-for-elementor' ),
					'separator' => 'before',
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'options' => [
						...
						'textarea' => [
							'title' => __( 'Textarea', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-bars',
						],
						'code' => [
							'title' => __( 'Code', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-code',
						],
					],
					'default' => 'text',
		...
		$this->add_control(
				'dce_clipboard_text', [
					...
					'type' => Controls_Manager::TEXT,
					'label_block' => true,
					'default' => 'https://www.dynamic.ooo',
					'condition' => [
						'dce_clipboard_type' => 'text',
					],
				]
		);
		$this->add_control(
				'dce_clipboard_textarea', [
					'label' => __( 'Text', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXTAREA,
					'label_block' => true,
					'default' => __( 'I am a sample text.', 'dynamic-content-for-elementor' ) . PHP_EOL . __( 'Discover more at', 'dynamic-content-for-elementor' ) . ' Dynamic.ooo',
					'condition' => [
						'dce_clipboard_type' => 'textarea',
					],
				]
		);
		$this->add_control(
				'dce_clipboard_code', [
					...
					'label_block' => true,
					'default' => "echo 'Hello Dynamic.ooo';",
					'condition' => [
						'dce_clipboard_type' => 'code',
					],
				]
		);
		...
		$this->add_control(
				'dce_clipboard_code_theme', [
					'label' => __( 'Theme', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'options' => $code_themes,
					'label_block' => true,
					'condition' => [
		...
		$this->add_control(
				'dce_clipboard_visible', [
					'label' => __( 'Visible value', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
				]
		);
		$this->add_control(
				'dce_clipboard_readonly', [
					'label' => __( 'Read Only', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => true,
					'condition' => [
						'dce_clipboard_visible!' => '',
		...
		$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .dce-clipboard-value',
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value' => 'fill: {{VALUE}}; color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value' => 'background-color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value:hover, {{WRAPPER}} .dce-clipboard-value:focus' => 'color: {{VALUE}};',
						'{{WRAPPER}} .dce-clipboard-value:hover svg, {{WRAPPER}} .dce-clipboard-value:focus svg' => 'fill: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value:hover, {{WRAPPER}} .dce-clipboard-value:focus' => 'background-color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value:hover, {{WRAPPER}} .dce-clipboard-value:focus' => 'border-color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
		);
		...
		$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
		);
		...
		$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-value' => 'height: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
				'dce_clipboard_btn_position',
				[
					'label' => __( 'Button Position', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::CHOOSE,
					'default' => 'static',
					'options' => [
						'static' => [
						...
						'absolute' => [
							'title' => __( 'Absolute', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-square-o',
						],
					],
					'toggle' => false,
		...
		$this->add_control(
				'dce_clipboard_btn_position_top',
				[
					'label' => __( 'Top', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 50,
					...
					'condition' => [
						'dce_clipboard_btn_position' => 'absolute',
					],
				]
		);
		$this->add_control(
				'dce_clipboard_btn_position_right',
				[
					'label' => __( 'Right', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'max' => 50,
		...
		$this->add_control(
				'dce_clipboard_btn_hide',
				[
					'label' => __( 'Button Visibility', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::CHOOSE,
					'default' => '1',
					'options' => [
						'1' => [
						...
						'0' => [
							'title' => __( 'On Hover', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-square-o',
						],
					],
					'toggle' => false,
					'selectors' => [
						'{{WRAPPER}} .dce-clipboard-wrapper .elementor-button' => 'opacity: {{VALUE}}; z-index: 3;',
						'{{WRAPPER}} .dce-clipboard-wrapper:hover .elementor-button' => 'opacity: 1;',
						'{{WRAPPER}} .dce-clipboard-wrapper .elementor-button.animated' => 'opacity: 1;',
					],
					'render_type' => 'template',
					'condition' => [
						'dce_clipboard_btn_position' => 'absolute',
	...
	protected function render() {
		...
		if ( $settings['dce_clipboard_type'] == 'code' && $settings['dce_clipboard_visible'] ) {
			...
			wp_enqueue_code_editor(array(
				'type' => $settings['dce_clipboard_code_type'],
				'codemirror' => array(
					'indentUnit' => 2,
					'tabSize' => 2,
				),
		...
		<script>
			<?php if ( $settings['dce_clipboard_type'] == 'code' && $settings['dce_clipboard_visible'] ) { ?>
			 jQuery(function () {
				if (wp.codeEditor) {
					var editorSettings = wp.codeEditor.defaultSettings ? _.clone( wp.codeEditor.defaultSettings ) : {};
					editorSettings.codemirror = _.extend( {}, editorSettings.codemirror,
						{
							mode: '<?php echo $settings['dce_clipboard_code_type']; ?>',
							readOnly: <?php echo $settings['dce_clipboard_readonly'] ? 'true' : 'false'; ?>,
							theme: '<?php echo $settings['dce_clipboard_code_theme'] ? $settings['dce_clipboard_code_theme'] : 'default'; ?>',
						}
					);
					var editor_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?> = wp.codeEditor.initialize( jQuery('#dce-clipboard-value-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>'), editorSettings );
				}
			});
			<?php } ?>
			<?php if ( $settings['animation_on_copy'] == 'shake-animation' ) { ?>
			jQuery(function () {
				var clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?> = new ClipboardJS('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>');
				clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?>.on('success', function (e) {
					jQuery('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>').addClass('animated').addClass('tada');
					setTimeout(function(){
						jQuery('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>').removeClass('animated').removeClass('tada');
					}, 3000);
					return false;
				});
				clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?>.on('error', function (e) {
					console.log(e);
				});
			});
			<?php } elseif ( $settings['animation_on_copy'] == 'change-text' ) { ?>
			jQuery(function () {
				var clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?> = new ClipboardJS('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>');
				clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?>.on('success', function (e) {
					jQuery('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>').html('<?php echo $settings['change_text']; ?>');
					return false;
				});
				clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?>.on('error', function (e) {
					console.log(e);
			...
			<?php } elseif ( $settings['animation_on_copy'] == 'none' ) { ?>
			jQuery(function () {
				var clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?> = new ClipboardJS('#dce-clipboard-btn-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>');
				clipboard_<?php echo $this->get_id(); ?>_<?php echo get_the_id(); ?>.on('error', function (e) {
					console.log(e);
