...
class DCE_Widget_PopUp extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		...
		$this->add_control(
				'show_popup_editor', [
					'label' => __( 'Show Modal Preview in Editor Mode', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'template',
				[
					'label' => __( 'Modal Template', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Template Name', 'dynamic-content-for-elementor' ),
					'label_block' => true,
					'query_type' => 'posts',
					'object_type' => 'elementor_library',
					'description' => __( 'Use an Elementor Template as content of the modal, helpful for complex structure.', 'dynamic-content-for-elementor' ),
					'condition' => [
		...
		$this->add_control(
				'modal_content', [
					'label' => __( 'Modal Content', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::WYSIWYG,
					'default' => __( 'Type here the content', 'dynamic-content-for-elementor' ),
					'description' => __( 'The main content of the modal. You can use Shortcode and Tokens.', 'dynamic-content-for-elementor' ),
					'dynamic' => [
						'active' => true,
					],
					'condition' => [
		...
		$this->add_control(
				'button_purpose', [
					...
					'options' => [
						...
						'close' => [
							'title' => __( 'Use button in template for close', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-window-close-o ',
						],
					],
					'default' => 'open',
					'description' => __( 'Decide if this is a simple Call-To-Action button to insert it in another modal to generate no modals for this widget. If you need to use another element to close the modal, add class <strong>.dce-button-close-modal</strong> to them.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'trigger' => 'button',
					],
					'separator' => 'before',
		...
		$this->add_control(
				'scroll_display_displacement', [
					...
					'default' => 0,
					'description' => __( 'Pixel to wait until make modal appear.', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'scroll_hide', [
					...
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Hide the modal when user scroll page.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'button_purpose!' => 'close',
					],
				]
		...
		$this->add_control(
				'close_delay', [
					...
					'type' => Controls_Manager::NUMBER,
					'default' => 0,
					'description' => __( 'Time in ms. Leave 0 for no delay. 1000 ms = 1 second.', 'dynamic-content-for-elementor' ),
					'frontend_available' => true,
					'condition' => [
						'scroll_hide!' => [ '', '0' ],
						'button_purpose!' => 'close',
		...
		$this->add_control(
				'esc_hide', [
					...
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'description' => __( 'Hide the modal when user press Esc button.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'button_purpose!' => 'close',
					],
				]
		...
		$this->add_control(
				'always_visible', [
					'label' => __( 'Show the modal on every page load', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'separator' => 'before',
					'frontend_available' => true,
					'condition' => [
		...
		$this->add_control(
				'cookie_lifetime', [
					...
					'default' => 0,
					'frontend_available' => true,
					'description' => __( 'Time in seconds. 86400 seconds is a day. 0 is still browser is open.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'always_visible' => '',
						'button_purpose!' => 'close',
						'trigger!' => 'button',
		...
		$this->add_control(
				'enabled_push', [
					...
					'frontend_available' => true,
					'separator' => 'before',
					'description' => __( 'Move body wrapper', 'dynamic-content-for-elementor' ),
					'condition' => [
						'button_purpose!' => 'close',
					],
				]
		...
		$this->add_control(
				'wrapper_maincontent', [
					...
					'description' => __( 'The ID of the main content of your site. (OceanWP uses: #wrap, Astra uses: #page)', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'frontend_available' => true,
					'default' => '#wrap',
					'placeholder' => '#wrap',
		...
		$this->add_control(
				'open_animation', [
					...
					'selectors' => [
						'body.modal-open-dce-popup-{{ID}} .dce-modal.dce-popup-{{ID}} .modal-dialog' => 'animation-name: {{VALUE}}Popup; -webkit-animation-name: {{VALUE}}Popup;',
					],
				]
		);
		...
		$this->add_control(
				'open_timingFunction', [
					...
					'selectors' => [
						'body.modal-open-dce-popup-{{ID}} .dce-push, body.modal-open-dce-popup-{{ID}} .dce-modal.dce-popup-{{ID}} .modal-dialog' => 'animation-timing-function: {{VALUE}}; -webkit-animation-timing-function: {{VALUE}};',
					],
				]
		);
		$this->add_control(
				'open_speed', [
					...
					'selectors' => [
						'body.modal-open-dce-popup-{{ID}} .dce-push, body.modal-open-dce-popup-{{ID}} .dce-modal.dce-popup-{{ID}} .modal-dialog.animated' => '-webkit-animation-duration: {{SIZE}}s; animation-duration: {{SIZE}}s',
					],
					'condition' => [
						'button_purpose!' => 'close',
					],
		...
		$this->add_control(
				'close_animation', [
					...
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-dialog' => 'animation-name: {{VALUE}}Popup; -webkit-animation-name: {{VALUE}}Popup;',
					],
				]
		);
		...
		$this->add_control(
				'close_timingFunction', [
					...
					'selectors' => [
						'body.modal-close-dce-popup-{{ID}} .dce-push, .dce-modal.dce-popup-{{ID}} .modal-dialog' => 'animation-timing-function: {{VALUE}}; -webkit-animation-timing-function: {{VALUE}};',
					],
				]
		);
		$this->add_control(
				'close_speed', [
					...
					'selectors' => [
						'body.modal-close-dce-popup-{{ID}} .dce-push, .dce-modal.dce-popup-{{ID}} .modal-dialog.animated' => '-webkit-animation-duration: {{SIZE}}s; animation-duration: {{SIZE}}s',
					],
					'condition' => [
						'button_purpose!' => 'close',
					],
		...
		$this->add_control(
				'background_layer', [
					'label' => __( 'Overlay', 'dynamic-content-for-elementor' ),
					'description' => __( 'Show a page overlay when the modal is visible', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
				]
		);
		...
		$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .dce-modal-background-layer:before, dce-popup-container.dce-popup-container-{{ID}} .dce-modal-background-layer:before',
					'condition' => [
		...
		$this->add_responsive_control(
				'overlay_opacity', [
					...
					'selectors' => [
						'dce-popup-container.dce-popup-container-{{ID}} .dce-modal-background-layer:before, {{WRAPPER}} .dce-modal-background-layer:before' => 'opacity: {{SIZE}};',
					],
					'condition' => [
						'background_layer' => 'yes',
					],
		...
		$this->add_control(
				'background_layer_close', [
					'label' => __( 'Close modal clicking on the background layer', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
						'background_layer!' => '',
					],
		...
		$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ '%', 'px', 'vw' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}}' => 'width: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'extend_full_window' => '',
					],
		...
		$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ '%', 'px', 'vh' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-content' => 'height: {{SIZE}}{{UNIT}};',
					],
					'condition' => [
						'extend_full_window' => '',
					],
		...
		$this->add_control(
				'modal_padding', [
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
		);
		$this->add_control(
				'modal_margin', [
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
		);
		$this->add_group_control(
				Group_Control_Typography::get_type(), [
					...
					'selector' => '.dce-modal.dce-popup-{{ID}} .modal-content',
					'condition' => [
						'content_type' => 'content',
					],
				]
		...
		$this->add_control(
				'modal_text_color', [
					...
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-content' => 'color: {{VALUE}};',
					],
					'condition' => [
						'content_type' => 'content',
					],
		...
		$this->add_control(
				'modal_background_color', [
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-content' => 'background-color: {{VALUE}};',
					],
				]
		);
		...
		$this->add_control(
				'modal_border_radius', [
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} .modal-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
		);
		...
		$this->add_control(
				'close_icon_color', [
					...
					'default' => '',
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'color: {{VALUE}};',
					],
					'condition' => [
						'close_type' => 'icon',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'x_close_text_color', [
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics:after, {{WRAPPER}} .dce-modal-close .dce-quit-ics:before, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:after, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:before' => 'background-color: {{VALUE}};',
					],
					'condition' => [
						'close_type' => 'x',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'close_bg_color', [
					...
					'default' => '',
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'background-color: {{VALUE}};',
					],
					'condition' => [
						'enable_close_button!' => '',
						'close_type!' => [ 'image', 'x' ],
		...
		$this->add_control(
				'x_close_bg_color', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics' => 'background-color: {{VALUE}};',
					],
				]
		);
		$this->add_group_control(
				Group_Control_Border::get_type(), [
					...
					'label' => __( 'Border', 'dynamic-content-for-elementor' ),
					'selector' => '.dce-modal.dce-popup-{{ID}} button.dce-close',
					'condition' => [
						'enable_close_button!' => '',
					],
				]
		...
		$this->add_control(
				'close_icon_color_hover', [
					...
					'default' => '',
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close:hover' => 'color: {{VALUE}};',
					],
					'condition' => [
						'close_type' => 'icon',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'x_close_text_color_hover', [
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close:hover .dce-quit-ics:after, {{WRAPPER}} .dce-modal-close:hover .dce-quit-ics:before, .dce-modal.dce-popup-{{ID}} .dce-modal-close:hover .dce-quit-ics:after, .dce-modal.dce-popup-{{ID}} .dce-modal-close:hover .dce-quit-ics:before' => 'background-color: {{VALUE}};',
					],
					'condition' => [
						'close_type' => 'x',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'close_background_color_hover', [
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} button.dce-close:hover, .dce-modal.dce-popup-{{ID}} button.dce-close:hover' => 'background-color: {{VALUE}};',
					],
					'condition' => [
						'close_type!' => [ 'image', 'x' ],
						'enable_close_button!' => '',
		...
		$this->add_control(
				'x_close_background_color_hover', [
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics:hover, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:hover' => 'background-color: {{VALUE}};',
					],
					'condition' => [
						'close_type' => 'x',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'close_bg_color_hover', [
					...
					'default' => '',
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close:hover' => 'border-color: {{VALUE}};',
					],
					'condition' => [
						'enable_close_button!' => '',
		...
		$this->add_responsive_control(
				'x_buttonsize_closemodal', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
					],
				]
		);
		$this->add_control(
				'x_weight_closemodal', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics:after, {{WRAPPER}} .dce-modal-close .dce-quit-ics:before, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:after, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:before' => 'height: {{SIZE}}{{UNIT}}; top: calc(50% - ({{SIZE}}{{UNIT}}/2));',
					],
				]
		);
		$this->add_control(
				'x_size_closemodal', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics:after, {{WRAPPER}} .dce-modal-close .dce-quit-ics:before, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:after, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics:before' => 'width: {{SIZE}}{{UNIT}}; left: calc(50% - ({{SIZE}}{{UNIT}}/2));',
					],
				]
		);
		$this->add_responsive_control(
				'x_vertical_close', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics' => 'top: {{SIZE}}{{UNIT}};',
					],
				]
		);
		$this->add_responsive_control(
				'x_horizontal_close', [
					...
					'selectors' => [
						'{{WRAPPER}} .dce-modal-close .dce-quit-ics, .dce-modal.dce-popup-{{ID}} .dce-modal-close .dce-quit-ics' => 'right: {{SIZE}}{{UNIT}};',
					],
				]
		);
		...
		$this->add_group_control(
				Group_Control_Typography::get_type(), [
					...
					'selector' => '.dce-modal.dce-popup-{{ID}} button.dce-close:not(i)',
					'condition' => [
						'close_type' => 'text',
						'close_text!' => '',
						'enable_close_button!' => '',
		...
		$this->add_responsive_control(
				'close_size', [
					...
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'font-size: {{SIZE}}{{UNIT}};',
						'.dce-modal.dce-popup-{{ID}} button.dce-close .close-img' => 'width: {{SIZE}}{{UNIT}}; height: auto;',
					],
					'condition' => [
		...
		$this->add_control(
				'close_bg_radius', [
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'condition' => [
						'close_type!' => 'x',
						'enable_close_button!' => '',
		...
		$this->add_control(
				'close_margin', [
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
					'condition' => [
						'close_type!' => 'x',
		...
		$this->add_control(
				'close_padding', [
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'.dce-modal.dce-popup-{{ID}} button.dce-close' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
					'condition' => [
						'close_type!' => 'x',
	...
	protected function render() {
				...
				if ( $settings['button_type'] == 'image' ) {
					if ( ! empty( $settings['button_image']['url'] ) ) {
						...
						<img class="button-img dce-button-popoup dce-button-img dce-button-<?php echo $settings['button_purpose']; ?>-modal dce-animation-<?php echo $settings['button_hover_animation']; ?>"
							 aria-hidden="true"
							 <?php if ( in_array( $settings['button_purpose'], array( 'open', 'next' ) ) ) {
									?>data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"<?php } ?>
							 src="<?php echo $settings['button_image']['url']; ?>" />
						 <?php }
				} else {
					?>
					<button class="dce-button-<?php echo $settings['button_purpose']; ?>-modal dce-button-popoup dce-animation-<?php echo $settings['button_hover_animation']; ?>"
						   <?php if ( in_array( $settings['button_purpose'], array( 'open', 'next' ) ) ) {
								?>data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"<?php } ?>
							>
		...
		if ( $settings['trigger'] == 'button' && $settings['button_type'] == 'hamburger' ) {
			?>
			<div class="dce-button-wrapper">
				<div class="dce-button-<?php echo $settings['button_purpose']; ?>-modal dce-button-hamburger dce-button-popoup dce-animation-<?php echo $settings['button_hover_animation']; ?>"
						 <?php if ( in_array( $settings['button_purpose'], array( 'open', 'next' ) ) ) {
								?>data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"<?php } ?>
					 >
			<?php if ( $settings['hamburger_style'] == 'x' ) { ?>
					...
					<?php } elseif ( $settings['hamburger_style'] == 'arrow_left' ) {
				?>
						<div class="con">
			...
			<?php } elseif ( $settings['hamburger_style'] == 'arrow_right' ) { ?>
						<div class="con">
							<div class="bar arrow-top"></div>
							<div class="bar arrow-middle"></div>
							<div class="bar arrow-bottom"></div>
						</div>
			<?php } elseif ( $settings['hamburger_style'] == 'fall' ) { ?>
		...
		if ( ( \Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['show_popup_editor'] && $settings['button_purpose'] != 'close' ) || ( ! \Elementor\Plugin::$instance->editor->is_edit_mode() && ! $this->checkCookie() ) || ( ! \Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['trigger'] == 'button' ) ) {
			...
			<div class="dce-popup-container dce-popup-container-<?php echo $this->get_id(); ?> dce-popup-<?php echo $settings['trigger'] . $fullWindow; ?>">
				...
				<?php if ( $settings['background_layer'] ) { ?>
					<div id="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>-background" class="animated dce-modal-background-layer<?php if ( $settings['background_layer_close'] ) {
						?> dce-modal-background-layer-close<?php } ?> modal-background-layer<?php if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
	?> block-i<?php } ?>" data-dismiss="modal" data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"></div>
			<?php } ?>

				<div id="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"
					 class="dce-popup-<?php echo $this->get_id(); ?> dce-modal<?php if ( $settings['esc_hide'] && ! \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
							?> modal-hide-esc<?php } ?><?php if ( $settings['scroll_hide'] && ! \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
	?> modal-hide-on-scroll<?php } ?> modal-<?php echo $settings['modal_align']; ?> modal-<?php echo $settings['modal_valign']; ?> <?php if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
	?> block-i<?php } ?>"
					 tabindex="-1"
					 role="dialog"
					 >

					<div class="modal-dialog<?php if ( $settings['open_animation'] ) {
						?> animated<?php echo $infinite;
											}
											?>" role="document" >
							...
							<div class="modal-body">
								...
								<button type="button" class="dce-close dce-modal-close close-<?php echo $settings['close_type']; ?> close-<?php echo $settings['close_align']; ?> close-<?php echo $settings['close_valign']; ?>" data-dismiss="modal" aria-label="Close">
									...
									<?php if ( $settings['close_type'] == 'text' ) {
										?><span class="dce-button-text"><?php echo $settings['close_text']; ?></span><?php } ?>

									<?php if ( $settings['close_type'] == 'icon' ) {
										?><?php if ( $settings['close_icon'] ) {
	?><i class="<?php echo esc_attr( $settings['close_icon'] ); ?>" aria-hidden="true"></i><?php } ?><?php } ?>
