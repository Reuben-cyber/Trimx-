	...
	protected function _register_controls_content() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'The Paged converter will be removed after June 30, 2021, if you are using it please switch to another converter.', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'toggle' => false,
				'default' => 'dynamic-content-for-elementor',
				'condition' => [
					'dce_pdf_button_converter' => [ 'dompdf', 'tcpdf' ],
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'description' => __( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'dynamic-content-for-elementor' ),
				'separator' => 'before',
			]
		);
