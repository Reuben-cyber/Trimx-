	...
	protected function _register_controls() {
		...
		$this->add_control(
			'text_btn', [
				...
				'default' => __( 'Fire Modal Window', 'dynamic-content-for-elementor' ),
			]
		);
		$this->add_control(
			'icon',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dce-modalwindow-section .icon-left' => 'padding-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dce-modalwindow-section .icon-right' => 'padding-left: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'icon!' => '',
				],
		...
		<section class="dce-modalwindow-section">
			...
			<div class="cd-modal">
				<div class="cd-modal-content">
			  	<?php echo do_shortcode( '[dce-elementor-template id="' . $template . '"]' ); ?>
				</div>
			</div>
