	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'condition' => [
					'query_type' => [ 'get_cpt', 'dynamic_mode', 'search_page', 'relationship' ],
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'querydate_field_meta_future_contains_today',
			[
				'label' => __( 'Future dates contains today\'s date', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => [
					'query_filter' => 'date',
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Type the Post Meta value. Type a sequence of comma-separated term IDs. (e.g.: "5,27,88")', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'current_user' => [
						'title' => __( 'Current user', 'dynamic-content-for-elementor' ),
						'icon' => 'fa fa-user',
					],
				],
				'default' => 'post_author',
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Type the Post Meta value. Type a sequence of author IDs separated by commas. (eg: 5,27,88)', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'render_type' => 'template',
				'default' => '',
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Type the Post Meta value. Type a sequence of metakey-type IDs separated by commas. (e.g.:"5,27,88")', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'render_type' => 'template',
				'default' => '',
				...
				if ( $settings['metakey_from'] == 'post_metakey' ) {
					...
					if ( $settings['metakey_field_meta'] ) {
						$args['meta_query'][] = [
							...
							'value' => sanitize_text_field( $settings['metakey_field_meta_value'] ),
							'compare' => $settings['metakey_field_meta_operator'],
						];
					}
