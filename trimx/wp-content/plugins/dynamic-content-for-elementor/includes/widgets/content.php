...
class DCE_Widget_Content extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'no_shortcode',
			[
				'label' => __( 'Remove Shortcodes', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Limit the display of the content', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .unfold-btn' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .unfold-btn:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .unfold-btn' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'unfold_space',
			[
				'label' => __( 'Icon Space', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 15,
				],
		...
		$this->add_responsive_control(
			'unfold_alignment', [
				'label' => __( 'Icon Alignment', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'toggle' => true,
				'options' => [
					'left' => [
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .unfold-btn' => 'text-align: {{VALUE}}; display: block;',
				],
			]
		);
		$this->end_controls_section();
