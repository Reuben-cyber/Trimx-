...
class DCE_Widget_AnimateText extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_animateText',
			[
				'label' => __( 'Animated Text', 'dynamic-content-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'animatetext-trigger-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text_word' => __( 'Type any word', 'dynamic-content-for-elementor' ),
					],
				],
				'separator' => 'after',
				'frontend_available' => true,
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'frontend_available' => true,
				'description' => __( 'Infinite: -1, repeat it once and hide it: 0', 'dynamic-content-for-elementor' ),
				'default' => -1,
				'min'     => -1,
				'max'     => 25,
				'step'    => 1,
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Negative values produce a contrary effect of origin', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
