...
class DCE_Widget_Favorites extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Counter', 'dynamic-content-for-elementor' ),
		...
		$repeater_fields->add_control(
			...
			[
				'label' => __( 'Icon Add', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'label_block' => true,
				'fa4compatibility' => 'icon',
			]
		...
		$repeater_fields->add_control(
			...
			[
				'label' => __( 'Icon Remove', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'label_block' => true,
				'fa4compatibility' => 'icon',
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Cache', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'dce_favorite_scope' => 'cookie',
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Before', 'dynamic-content-for-elementor' ),
						'icon' => 'fa fa-align-left',
					],
					'right' => [
						'title' => __( 'After', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'counter_align',
			[
				'label' => __( 'Counter Position', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'left',
				'options' => [
					'left' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Separator width', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 3,
				],
		...
		$this->add_control(
			'counter_padding',
			[
				'label' => __( 'Counter Padding', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			'counter_indent',
			[
				'label' => __( 'Counter Spacing', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->start_controls_section(
			'section_visitors',
			[
				'label' => __( 'Visitors', 'dynamic-content-for-elementor' ),
				'condition' => [
		...
		$this->start_controls_tab(
			'tab_button_disabled',
			[
				'label' => __( 'Disabled', 'dynamic-content-for-elementor' ),
				'condition' => [
					'dce_favorite_remove' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Success Message Color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'error_message_color',
			[
				'label' => __( 'Error Message Color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$settings['dce_favorite_ajax'] = 'yes';
		if ( empty( $settings ) ) {
			return;
		}
		...
		if ( $settings['dce_favorite_scope'] == 'global' && $settings['dce_favorite_sticky'] ) {
			$settings['dce_favorite_list'] = [
				[
					'dce_favorite_title_add' => wp_kses_post( $settings['dce_favorite_title_add'] ),
					'dce_favorite_icon_add' => $settings['dce_favorite_icon_add'],
					'dce_favorite_title_remove' => wp_kses_post( $settings['dce_favorite_title_remove'] ),
			...
			<?php if ( ( $settings['dce_favorite_ajax'] || $act_add || \Elementor\Plugin::$instance->editor->is_edit_mode() ) && $settings['dce_favorite_msg_add_enable'] ) {
				...
				<div class="elementor-message elementor-message-success dce-notice dce-notice-favorite dce-notice-favorite-add elementor-alert elementor-alert-success<?php echo $modal_class; ?>"<?php if ( $settings['dce_favorite_ajax'] && ! \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
					...
					<button type="button" class="elementor-alert-dismiss" onClick="jQuery(this).parent().fadeOut();">
						...
						<span class="elementor-screen-only"><?php echo __( 'Dismiss alert', 'dynamic-content-for-elementor' ); ?></span>
					</button>
				</div>
				<?php
			}
