...
class DCE_Widget_Acf extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'acf_field_list',
			[
				'label' => __( 'Select ACF Field', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'list' => __( 'List (Radio or Checkbox)', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'acf_currency_type',
			[
				'label' => __( 'Currency type', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
		...
		$this->add_control(
			'acf_integerDecimalOpt',
			[
				'label' => __( 'Set upto decimal integer', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'drop_cap',
			[
				'label' => __( 'Drop Cap', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			...
			[
				'label' => 'Settings',
				'condition' => [
					'acf_type' => [ 'text', 'wysiwyg', 'textarea', 'date', 'image', 'empty', 'select', 'list' ],
				],
			]
		);
		$this->add_control(
			'list_array_return',
			[
				'label' => __( 'List Return Value', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Label: Value', 'dynamic-content-for-elementor' ),
					'label' => __( 'Label', 'dynamic-content-for-elementor' ),
					'value' => __( 'Value', 'dynamic-content-for-elementor' ),
				],
				'default' => '',
				'condition' => [
					'acf_type' => 'list',
		...
		$this->add_control(
			'list_style',
			[
				'label' => __( 'List Style', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'inline-block' => __( 'Horizontal', 'dynamic-content-for-elementor' ),
					'block' => __( 'Vertical', 'dynamic-content-for-elementor' ),
				],
				...
				'selectors' => [
					'{{WRAPPER}} .dce-acf-list' => 'display: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'groups' => Helper::get_acf_field_urlfile( true ),
		...
		$this->add_control(
			'acf_field_url_nofollow',
			[
				'label' => __( 'NoFollow', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'link_to' => 'acf_url',
				],
		...
		$this->add_responsive_control(
			'height',
			[
				'label' => __( 'Background Minimum Height', 'dynamic-content-for-elementor' ),
		...
		$this->add_responsive_control(
			'bg_width',
			[
				'label' => __( 'Background Width', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
					'unit' => 'px',
		...
		$this->add_control(
			'List_heading',
			[
				'label' => __( 'List', 'dynamic-content-for-elementor' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'typography_list_label',
				'label' => __( 'Label Typography', 'dynamic-content-for-elementor' ),
				'selector' => '{{WRAPPER}} .dce-acf-list-label',
				'condition' => [
					'acf_type' => [ 'list' ],
					'list_array_return' => 'label',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dce-acf-list-inline-block .dce-acf-list:not(:first-child)' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dce-acf-list-inline-block .dce-acf-list:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dce-acf-list-block .dce-acf-list:not(:forst-child)' => 'margin-top: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dce-acf-list-block .dce-acf-list:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'acf_type' => [ 'list' ],
				],
		...
		$this->add_responsive_control(
			'list_width',
			[
				'label' => __( 'Label width', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
				],
				...
				'selectors' => [
					'{{WRAPPER}} .dce-acf-list-label' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'acf_type' => [ 'list' ],
					'list_array_return' => 'label',
		...
		$this->add_control(
			'tx_before_color_hover',
			[
				'label' => __( 'Text Before Color Hover', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dynamic-content-for-elementor-acf span.tx-before' => 'color: {{VALUE}};',
					'{{WRAPPER}} .dynamic-content-for-elementor-acf a:hover span.tx-before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'acf_text_before!' => '',
				],
		...
		$this->add_control(
			'tx_after_color_hover',
			[
				'label' => __( 'Text After Color Hover', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dynamic-content-for-elementor-acf span.tx-after' => 'color: {{VALUE}};',
					'{{WRAPPER}} .dynamic-content-for-elementor-acf a:hover span.tx-after' => 'color: {{VALUE}};',
				],
				'condition' => [
					'acf_text_after!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'stacked' => __( 'Stacked', 'dynamic-content-for-elementor' ),
					'framed' => __( 'Framed', 'dynamic-content-for-elementor' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Primary Color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Secondary Color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		if ( $typeField == 'text' ||
			...
			if ( $typeField == 'list' ) {
				...
				$acfResult = '<' . $field_wrapper . ' class="dce-acf-list-' . $settings['list_style'] . '">'; // l'elemento Item Wrap
				...
				$acfResult .= '</' . $field_wrapper . '>'; // end wrap
			} else {
