	...
	protected function _register_controls_content() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'charachters' => __( 'Characters', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => Helper::get_gravatar_styles(),
				'default' => 'monsterid',
				'condition' => [
					'dce_user_key' => 'avatar',
				],
			...
			if ( $settings['dce_user_image_gravatar'] == '404' ) {
				...
				if ( is_array( $img_content ) ) {
					if ( wp_remote_retrieve_response_code( $img_content ) == 404 ) {
						$meta_values = [ '' ]; // to use a fallback if enabled
					}
				}
			}
