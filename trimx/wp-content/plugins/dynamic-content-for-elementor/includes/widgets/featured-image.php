	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Absolutely position the image by spreading it over the entire column. Warning: the height of the image depends on the elements contained in the column.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Yes', 'dynamic-content-for-elementor' ),
				'label_off' => __( 'No', 'dynamic-content-for-elementor' ),
		...
		$this->add_responsive_control(
			'maxwidth', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-featured-image' => 'max-width: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			'maxheight', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-featured-image' => 'max-height: {{SIZE}}{{UNIT}};',
