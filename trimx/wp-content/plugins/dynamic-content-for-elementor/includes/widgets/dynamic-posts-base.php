	...
	protected function register_base_controls() {
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'_skin' => [ '', 'grid', 'carousel', 'grid-filters', 'dualcarousel' ],
		...
		$this->add_control(
				...
				[
					...
					'content_classes' => 'dce-skin-dis dce-pagination-dis',
					'condition' => [
						'_skin' => [ '', 'grid', 'grid-filters', 'timeline' ],
						'pagination_enable' => 'yes',
		...
		$this->add_control(
			'pagination_enable', [
				...
				'separator' => 'before',
				'condition' => [
					'_skin' => [ '', 'grid', 'grid-filters', 'gridtofullscreen3d' ],
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'style_items', [
				...
				'frontend_available' => true,
				'condition' => [
					'_skin' => [ '', 'grid', 'grid-filters', 'carousel', 'filters', 'dualcarousel', 'smoothscroll', '3d' ],
				],
			]
		);
		...
		$this->add_responsive_control(
			'image_rate', [
				...
				'condition' => [
					'_skin' => [ '', 'grid', 'carousel', 'grid-filters', 'dualcarousel', 'smoothscroll', '3d' ],
		...
		$this->add_control(
			'images_mask', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-posts-container .dce-post-image img' => '-webkit-mask-image: url({{VALUE}}); mask-image: url({{VALUE}}); -webkit-mask-position: 50% 50%; mask-position: 50% 50%; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-size: contain; mask-size: contain;',
				],
			]
		);
		$this->add_control(
			'custom_image_mask',
			[
				'label' => __( 'Select a PNG file', 'dynamic-content-for-elementor' ),
				...
				'selectors' => [
					'{{WRAPPER}} .dce-posts-container .dce-post-image img' => '-webkit-mask-image: url({{URL}}); mask-image: url({{URL}}); -webkit-mask-position: 50% 50%; mask-position: 50% 50%; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-size: contain; mask-size: contain;',
				],
				'condition' => [
					'_skin' => [ '', 'grid', 'carousel', 'grid-filters', 'dualcarousel', 'smoothscroll', '3d' ],
					'style_items!' => [ 'default', 'template' ],
		...
		$this->add_control(
			'clippath_mask', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-posts-container .dce-post-image img' => '-webkit-clip-path: {{VALUE}}; clip-path: {{VALUE}};',
				],
			]
		);
		$this->end_popover();
		...
		$this->add_control(
			'contentstyle_popover', [
				...
				'render_type' => 'ui',
				'condition' => [
					'_skin' => [ '', 'grid', 'carousel', 'grid-filters', 'dualcarousel', 'smoothscroll' ],
					'style_items!' => [ 'default', 'template' ],
				],
			]
		);
		...
		$this->add_control(
			'force_layout_default', [
				'label' => '<i class="dynicon eicon-device-mobile" aria-hidden="true"></i> ' . __( 'Force default layout on mobile', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'prefix_class' => 'force-default-mobile-',
				'condition' => [
					'_skin' => [ '', 'grid', 'grid-filters', 'carousel', 'dualcarousel', 'smoothscroll', '3d' ],
					'style_items' => [ 'left', 'right', 'alternate' ],
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => false,
				'options' => [
					'item_title' => __( 'Title', 'dynamic-content-for-elementor' ),
					'item_image' => __( 'Featured Image', 'dynamic-content-for-elementor' ),
					'item_date' => __( 'Date', 'dynamic-content-for-elementor' ),
					'item_termstaxonomy' => __( 'Terms', 'dynamic-content-for-elementor' ),
					'item_content' => __( 'Content', 'dynamic-content-for-elementor' ),
					'item_author' => __( 'Author', 'dynamic-content-for-elementor' ),
					'item_custommeta' => __( 'Custom Meta Fields', 'dynamic-content-for-elementor' ),
					'item_readmore' => __( 'Read More', 'dynamic-content-for-elementor' ),
					'item_posttype' => __( 'Post Type', 'dynamic-content-for-elementor' ),
				],
				'default' => 'item_title',
			]
		);
		...
		$repeater->add_control(
			'posttype_label', [
				'label' => __( 'Post Type Label', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'plural',
				'options' => [
		...
		$repeater->start_controls_tab('tab_style', [
			...
			$repeater->add_responsive_control(
				'image_align', [
					...
					'default' => 'top',
					'selectors' => [
						'{{WRAPPER}} {{CURRENT_ITEM}}.dce-item_image' => 'justify-content: {{VALUE}};',
					],
					'conditions' => [
						'terms' => [
							[
			...
			$repeater->add_control(
				'bgcolor_item', [
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} {{CURRENT_ITEM}} *:not(.dce-post-button) > *' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Show these items', 'dynamic-content-for-elementor' ),
				...
				'title_field' => '{{{ posts_v2_item_id_to_label(item_id) }}}',
			]
		);
		...
		$this->add_control('notice_custom_meta', [
				'type' => Controls_Manager::RAW_HTML,
				'raw' => '<div class="elementor-panel-alert elementor-panel-alert-warning">' . __( 'Please notice that changing the settings in this section has only any effect whenever a Custom Fields item has been selected in the Items section.', 'dynamic-content-for-elementor' ) . '</div>',
			]);
		...
		$this->start_controls_section(
			'section_hover_effect', [
				...
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'_skin' => [ '', 'grid', 'grid-filters', 'carousel', 'dualcarousel' ],
					'style_items!' => 'template',
				],
			]
		);
