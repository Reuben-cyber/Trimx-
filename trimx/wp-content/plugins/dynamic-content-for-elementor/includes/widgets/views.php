...
class DCE_Widget_Views extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
			...
			[
				...
				'options' => 
					[
						...
						'slideshow' => __( 'Carousel', 'dynamic-content-for-elementor'),
					],
				'default' => 'grid',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Carousel Options', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'none',
				'options' => [
					'both' => __('Arrows and Dots', 'dynamic-content-for-elementor'),
					'arrows' => __('Arrows', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			'pause_on_hover',
			[
				'label' => __('Pause on Hover', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Pause on Interaction', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
				'condition' => [
		...
		$this->add_control(
			'infinite',
			[
				'label' => __('Infinite Loop', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
				'condition' => [
		...
		$this->add_control(
			'transition_speed',
			[
				'label' => __('Animation Speed', 'dynamic-content-for-elementor') . ' (ms)',
				'type' => Controls_Manager::NUMBER,
				'default' => 500,
				'frontend_available' => true,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Carousel Navigation', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'dce_views_style_format' => 'slideshow',
		...
		$this->add_responsive_control(
			...
			[
					'label' => __('Column Width', 'dynamic-content-for-elementor'),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'' => __('Default', 'dynamic-content-for-elementor'),
						'100' => '100%',
		...
		$this->add_control(
			...
			'default' => '[post:thumb]<h4>[post:title]</h4><p>[post:excerpt]</p><a class="btn btn-primary" href="[post:permalink]">' . __("Read more", 'dynamic-content-for-elementor') . '</a>',
			'condition' => [
		...
		$repeater_fields->add_group_control(
			Group_Control_Image_Size::get_type(), [
				'name' => 'dce_views_select_image',
				'label' => __( 'Image Format', 'dynamic-content-for-elementor' ),
				'default' => 'large',
				'condition' => [
					'dce_views_select_render' => 'image',
				],
			]
		);
		$repeater_fields->add_control(
		...
		$this->add_control(
			...
			[
			'label' => __('Show these fields', 'dynamic-content-for-elementor'),
		...
		$this->add_control(
			...
			'type' => Controls_Manager::SWITCHER,
			'description' => __('Ignore the posts order priorirty on top of Sticky Posts.', 'dynamic-content-for-elementor'),
			'separator' => 'after',
			'condition' => [
				'dce_views_from_dynamic' => '',
				'dce_views_object' => 'post',
		...
		$this->add_control(
			...
			[
				...
				'multiple' => true,
				'separator' => 'before',
				'description' => __('Exclude posts related to this terms', 'dynamic-content-for-elementor'),
				'condition' => [
					'dce_views_from_dynamic' => '',
					'dce_views_object' => 'post',
				],
		...
		$this->add_control(
			'dce_views_where',
			[
				'label' => __('Filter by these conditions', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::REPEATER,
		...
		$repeater_form->add_control(
			'dce_views_where_form_field_orderby',
			[
				'label' => __( 'Order by', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'name' => __( 'Name', 'dynamic-content-for-elementor' ),
					'parent' => __( 'Parent', 'dynamic-content-for-elementor' ),
					'count' => __( 'Count (number of associated posts)', 'dynamic-content-for-elementor' ),
					'term_order' => __( 'Order', 'dynamic-content-for-elementor' ),
					'slug' => __( 'Slug', 'dynamic-content-for-elementor' ),
					'term_group' => __( 'Group', 'dynamic-content-for-elementor' ),
					'term_id' => 'ID',
				],
				'default' => 'name',
				'condition' => [ 
		...
		$repeater_form->add_control(
			'dce_views_where_form_field_order',
			[
		...
		$repeater_form->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => '[field]',
				'description' => __('Use Token notation to access to sub field value. Example:', 'dynamic-content-for-elementor') . '[field:sub_field], [field:sub_array:sub_sub_field], [field:0:sub_field]',
				'condition' => [
					'dce_views_where_form_field_is_sub!' => '',
				],
			]
		...
		$repeater_form->add_control(
			...
			[
				'label' => __('Type', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => array('text' => 'Text', 'select' => 'Select', 'radio' => 'Radio', 'checkbox' => 'Checkbox', 'auto' => 'AUTO'),
				'default' => 'auto',
			]
		);
		$repeater_form->add_control(
		...
		$repeater_form->add_control(
			...
			'type' => Controls_Manager::TEXTAREA,
			'rows' => 2,
			'description' => __('If select/checkbox/radio use one line for option, use | to separate value and name (e.g.:"my_value|Name of the option").', 'dynamic-content-for-elementor'),
			'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Input Size', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => Helper::bootstrap_button_sizes(),
				'default' => 'sm',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'dce_views_group_by_field_orderby',
			[
				'label' => __( 'Order by', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			'dce_views_group_by_field_order',
			[
				'label' => __('Sorting', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
		...
		$repeater_order->add_control(
			...
			[
				...
				'options' => [
					'' => __('Default', 'dynamic-content-for-elementor'),
					'_num' => __('Number', 'dynamic-content-for-elementor'),
					'_date' => __('Date', 'dynamic-content-for-elementor'),
				],
			]
		);
		$repeater_order->add_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Form Width', 'dynamic-content-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __('Default', 'dynamic-content-for-elementor'),
					'100' => '100%',
		...
		$this->add_control(
			...
			'label' => __('Label', 'dynamic-content-for-elementor'),
			'type' => Controls_Manager::TEXT,
			'default' => __('Sort by', 'dynamic-content-for-elementor'),
			'condition' => [
				'dce_views_order_by!' => [],
			],
				]
		...
		$this->add_control(
			'dce_views_limit_to',
			[
			'label' => __('Max allowed results displayed', 'dynamic-content-for-elementor'),
			'type' => Controls_Manager::NUMBER,
			'default' => 0,
			'min' => 0,
		...
		$this->add_control(
			...
			[
					...
					'options' => [
						...
						'numbers' => __('Numbers', 'dynamic-content-for-elementor'),
						'prev_next' => __('Previous/Next', 'dynamic-content-for-elementor'),
						'numbers_and_prev_next' => __('Numbers', 'dynamic-content-for-elementor') . ' + ' . __('Previous/Next', 'dynamic-content-for-elementor'),
					],
					'condition' => [
						'dce_views_pagination!' => '',
					],
		...
		$this->add_control(
			...
			[
					'label' => __('Page Limit', 'dynamic-content-for-elementor'),
					'type' => Controls_Manager::NUMBER,
					'default' => 0,
					'min' => 0,
					'condition' => [
		...
		$this->add_control(
			...
			[
					'label' => __('Shorten', 'dynamic-content-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'condition' => [
						'dce_views_pagination!' => '',
		...
		$this->add_control(
			...
			[
					...
					'default' => __('&laquo; Previous', 'dynamic-content-for-elementor'),
					'condition' => [
						'dce_views_pagination!' => '',
						'dce_views_pagination_type' => [
							'prev_next',
		...
		$this->add_control(
			...
			[
					...
					'default' => __('Next &raquo;', 'dynamic-content-for-elementor'),
					'condition' => [
						'dce_views_pagination!' => '',
						'dce_views_pagination_type' => [
							'prev_next',
		...
		$this->add_control(
			'dce_views_fallback',
			[
			'label' => __('Fallback Content', 'dynamic-content-for-elementor'),
			'type' => Controls_Manager::SWITCHER,
		...
		$this->start_controls_tab(
			...
			[
				'label' => __('TR', 'dynamic-content-for-elementor'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
					'label' => __('TR:head', 'dynamic-content-for-elementor'),
				]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
					'label' => __('TR:even', 'dynamic-content-for-elementor'),
				]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
					'label' => __('TR:odd', 'dynamic-content-for-elementor'),
				]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
					'label' => __('TR:hover', 'dynamic-content-for-elementor'),
				]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
					'label' => __('TH', 'dynamic-content-for-elementor'),
				]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => __('TD', 'dynamic-content-for-elementor'),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => '<b>' . __('Edit TD style from Single Result section', 'dynamic-content-for-elementor') . '</b>',
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __('You will find many other specific style settings in the "Single Result" section here below', 'dynamic-content-for-elementor'),
			]
		);
		$this->end_controls_tab();
		...
		$this->start_controls_tab(
			...
			[
				'label' => __('TD:first', 'dynamic-content-for-elementor'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => __('TD:last', 'dynamic-content-for-elementor'),
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body:not(.rtl) {{WRAPPER}} .elementor-pagination li .page-numbers' => 'margin-left: calc( {{SIZE}}{{UNIT}}/2 ); margin-right: calc( {{SIZE}}{{UNIT}}/2 );',
					'body.rtl {{WRAPPER}} .elementor-pagination li .page-numbers' => 'margin-right: calc( {{SIZE}}{{UNIT}}/2 ); margin-left: calc( {{SIZE}}{{UNIT}}/2 );',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Load more Button', 'dynamic-content-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'dce_views_pagination!' => '',
					'dce_views_pagination_type' => [
	...
	public function _loop($settings = null) {
		...
		if (!empty($objects)) {
			...
			if (!empty($settings['dce_views_group_by_field'])) {
				...
				if ($taxonomy) {
					...
					if ($settings['dce_views_object'] == 'post') {
						$taxonomies_terms = Helper::get_taxonomy_terms($taxonomy, false, '', true, $settings['dce_views_group_by_field_orderby'], $settings['dce_views_group_by_field_order'] );
			...
			foreach ($objects as $key => $dce_obj) {
				...
				// 	echo '<div class="' . $settings['dce_views_group_by_class_wrapper'] . '">';
				// }
				$obj_count++;
				...
				if (!empty($settings['dce_views_group_by_field'])) {
					if ($settings['dce_views_object'] == 'post' && $taxonomy) {
						...
						$group_value = Helper::{$get_meta}($dce_obj_id, $settings['dce_views_group_by_field'], true);
					}
					...
					if ($obj_display > 1) {
						...
						if (in_array($settings['navigation'], ['arrows', 'both'])) {
							...
							<div class="elementor-swiper-button elementor-swiper-button-prev">
								...
								<span class="elementor-screen-only"><?php _e('Previous', 'dynamic-content-for-elementor'); ?></span>
							</div>
							<div class="elementor-swiper-button elementor-swiper-button-next">
								<i class="eicon-chevron-<?php echo $next; ?>" aria-hidden="true"></i>
								<span class="elementor-screen-only"><?php _e('Next', 'dynamic-content-for-elementor'); ?></span>
							</div>
							<?php
						}
					}
						...
						<div class="dce-view-exposed-sort-row elementor-row">
							<div class="elementor-column elementor-col-<?php echo $settings['dce_views_order_form_width']; ?>">
								<form action="<?php echo $form_action; ?>" method="get" class="dce-view-exposed-sort <?php echo $settings['dce_views_order_class']; ?>">
									...
									<?php } ?>
									<?php if (isset($_GET['p'])) { ?>
										<input type="hidden" name="p" value="<?php echo sanitize_text_field($_GET['p']); ?>">
									<?php } ?>
			...
			foreach ($settings['dce_views_where_form'] as $afield) {
				if (isset($_GET[$afield['dce_views_where_form_field']]) || $settings['dce_views_where_form_result']) {
					...
					if (!empty($_GET['eid']) && $_GET['eid'] == $this->get_id() && isset($_GET[$afield['dce_views_where_form_field']])) {
						$afield_value = sanitize_text_field($_GET[$afield['dce_views_where_form_field']]);
					}
