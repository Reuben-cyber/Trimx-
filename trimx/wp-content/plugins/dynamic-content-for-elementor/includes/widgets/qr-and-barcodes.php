	...
	protected function _register_controls_content() {
		...
		$this->add_control(
				'dce_barcode_code', [
					'label' => __( 'Code', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'description' => __( 'The value of barcode, can be an URL, a NUMBER or a simple TEXT', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				...
				[
					...
					'options' => [
						...
						'PngData' => [
							'title' => __( 'PNG', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-image',
						],
						'HTML' => [
							'title' => __( 'HTML', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-code',
						],
					],
					'default' => 'PngData',
