...
class DCE_Widget_NextPrev extends DCE_Widget_Prototype {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'new_icon_left',
			[
				'label' => __( 'Left Icon', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon_left',
				'label_block' => false,
				'skin' => 'inline',
				'default' => [
		...
		$this->add_control(
			'new_icon_right',
			[
				'label' => __( 'Right Icon', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon_right',
				'label_block' => false,
				'skin' => 'inline',
				'default' => [
		...
		$this->add_control(
			'same_term', [
				...
				'description' => __( 'Navigate between posts in the same taxonomy term', 'dynamic-content-for-elementor' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				'name' => 'typography_1',
				'label' => $this->get_title() . ' ' . __( 'Typography', 'dynamic-content-for-elementor' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				'name' => 'typography_2',
				'label' => __( 'Post Title Typography', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'color_3', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} i.fas, {{WRAPPER}} i.far, {{WRAPPER}} i.fab' => 'color: {{VALUE}};',
					'{{WRAPPER}} a i.fas, {{WRAPPER}} a i.fab, {{WRAPPER}} a i.far' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'hover_color_icon', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} a:hover i.fas, {{WRAPPER}} a:hover i.far, {{WRAPPER}} a:hover i.fab' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'icon_size', [
				...
				'selectors' => [
					'{{WRAPPER}} .nav-links span .fas, {{WRAPPER}} .nav-links span .far, {{WRAPPER}} .nav-links span .fab' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'icon_space', [
				...
				'selectors' => [
					'{{WRAPPER}}.nav-classic nav.post-navigation .nav-next .fas, {{WRAPPER}}.nav-classic nav.post-navigation .nav-next .fab, {{WRAPPER}}.nav-classic nav.post-navigation .nav-next .far' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.nav-classic nav.post-navigation .nav-previous .fas, {{WRAPPER}}.nav-classic nav.post-navigation .nav-previous .fab, {{WRAPPER}}.nav-classic nav.post-navigation .nav-previous .far' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'style_postnav' => 'classic',
				],
		...
		$this->add_responsive_control(
			'icon_verticalalign', [
				...
				'selectors' => [
					'{{WRAPPER}}.nav-classic .nav-links .fas, {{WRAPPER}}.nav-classic .nav-links .fab, {{WRAPPER}}.nav-classic .nav-links .far' => 'top: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'style_postnav' => 'classic',
				],
