...
class DCE_Widget_GoogleMaps extends DCE_Widget_Prototype {
	...
	protected function register_controls_content() {
		...
		if( ! get_option( 'dce_google_maps_api' ) ) {
			$this->add_control(
				...
				'raw' => __( 'In order to use this feature you should set Google Maps API, with Geocoding API enabled, on APIs section', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'map_data_type', [
				...
				'options' => [
					'address' => [
						'title' => __( 'Address', 'dynamic-content-for-elementor' ),
						'return_val' => 'val',
						'icon' => 'fa fa-map-marker-alt',
					],
					'latlng' => [
						'title' => __( 'Latitude and longitude', 'dynamic-content-for-elementor' ),
						'return_val' => 'val',
						'icon' => 'fa fa-globe-europe',
					],
					'acfmap' => [
						'title' => __( 'ACF Google Map Field', 'dynamic-content-for-elementor' ),
						'return_val' => 'val',
						'icon' => 'fa fa-map',
					],
				],
		...
		$this->add_control(
				'acf_mapfield',
				[
					'label' => __( 'ACF Google Map field', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
		...
		$this->add_control(
			'address', [
				'label' => __( 'Address', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Venice', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'latitudine', [
				'label' => __( 'Latitude', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => '45.4371908',
				'condition' => [
		...
		$this->add_control(
			'longitudine', [
				'label' => __( 'Longitude', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => '12.3345898',
				'condition' => [
					'map_data_type' => 'latlng',
		...
		$this->add_control(
			'use_query', [
				'label' => __( 'Multiple Locations Query', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'query_type', [
				...
				'options' => [
					'get_cpt' => [
						'title' => __( 'Custom Post Type', 'dynamic-content-for-elementor' ),
						'icon' => 'fa fa-files-o',
					],
					'dynamic_mode' => [
		...
		$this->add_control(
			'ignore_pagination', [
				'label' => __( 'Ignore pagination', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'frontend_available' => true,
				'condition' => [
		...
		if ( $searchfilterpro_activated ) {
			if ( version_compare( SEARCH_FILTER_VERSION, '2.5.5', '>=' ) ) {
				...
				$this->add_control(
				  ...
				  [
					  'label' => '<b>' . __( 'Important Note', 'dynamic-content-for-elementor' ) . '</b>',
					  'type' => Controls_Manager::RAW_HTML,
					  'raw' => __( 'In order to use this feature you need Search & Filter Pro version >= 2.5.5', 'dynamic-content-for-elementor' ),
					  'condition' => [
						  'query_type' => 'search_filter',
						  'map_data_type' => 'acfmap',
					  ],
		...
		$this->add_control(
			'category', [
				...
				'description' => __( 'Category IDs separate by comma', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'fallback_text', [
				...
				'default' => __( 'No positions found.', 'dynamic-content-for-elementor' ),
		...
		$this->start_controls_section(
			'section_maps_controlling', [
				'label' => __( 'Controlling', 'dynamic-content-for-elementor' ),
			]
		);

		$this->add_control(
			'geolocation', [
				'label' => __( 'Geolocation', 'dynamic-content-for-elementor' ),
				'description' => __( 'Display the geographic location of the user on the map, using browser\'s HTML5 Geolocation', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'geolocation_button_text', [
				'label' => __( 'Text for Geolocation button', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Pan to Current Location', 'dynamic-content-for-elementor' ),
				'label_block' => 'true',
				'frontend_available' => true,
				'condition' => [
					'geolocation' => 'yes',
		...
		$this->add_control(
			'prevent_scroll', [
				...
				'description' => __( 'When a user scrolls a page that contains a map, the scrolling action can unintentionally cause the map to zoom. This behavior can be controlled using this option.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->add_control(
			'enable_infoWindow', [
				'label' => __( 'InfoWindow', 'dynamic-content-for-elementor' ),
				'description' => __( 'An InfoWindow displays content in a popup window above the map, at a given location.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'separator' => 'before',
				'render_type' => 'template',
		...
		$this->add_control(
			'style_map', [
				'label' => __( 'Snazzy JSON Style Map', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'default' => '[post:ID|get_the_post_thumbnail(thumbnail)]<h4>[post:title]</h4>[post:excerpt]<br><a href="[post:permalink]">READ MORE</a>',
				'condition' => [
					'infoWindow_click_to_post' => '',
					'use_query!' => '',
		...
		$this->add_control(
			...
			[
				'label' => __( 'ACF Image for Content Area', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
		...
		$this->add_control(
			...
			[
				'label' => __( 'ACF Field for Title', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
		...
		$this->add_control(
			...
			[
				'label' => __( 'ACF Field for Content', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
		...
		$this->add_control(
			'acf_repeater_iwlink',
			[
				'label' => __( 'ACF URL Field for Read More Link', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
		...
		$this->add_control(
			'acf_markerfield',
			[
				'label' => __( 'Marker from an ACF Image field', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
	...
	protected function render() {
		...
		<?php
		if ( $settings['map_data_type'] === 'address' && ! isset( $indirizzo )
			 || $settings['map_data_type'] === 'latlng' && ( ! isset( $lat ) || ! isset( $lng ) )
			 || $settings['map_data_type'] === 'acfmap' && ( ! isset( $lat ) || ! isset( $lng ) )
		  ) { ?>
			<?php
	...
	protected function render_fallback() {
		...
		$this->add_render_attribute( 'container', [
			'class' => [
				'dce-dynamic-google-maps-fallback',
			],
		] );
		?>
