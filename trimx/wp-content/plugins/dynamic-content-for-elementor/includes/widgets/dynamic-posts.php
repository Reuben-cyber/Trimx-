...
class DCE_Widget_DynamicPosts extends DCE_Widget_Prototype {
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'dce-jquery-slick', 'isotope', 'dce-infinitescroll', 'dce-wow', 'dce-ajaxmodal', 'dce-acf_posts' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'acf_relationship_invert',
			[
				'label' => __( 'Invert direction', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'For bidirectional relationships, retrieve all posts that are associated to a current post', 'dynamic-content-for-elementor' ),
				'condition' => [
					'query_type' => 'acf_relations',
				],
			]
		...
		$this->add_control(
					'exclude_io',
					[
						'label' => __( 'Exclude Current Post', 'dynamic-content-for-elementor' ),
						'type' => Controls_Manager::SWITCHER,
						'default' => 'yes',
						'condition' => [
		...
		$this->start_controls_section(
				'section_queryopt',
				[
					'label' => __( 'Parent Query', 'dynamic-content-for-elementor' ),
					'condition' => [
						'query_type' => [ 'get_cpt', 'dynamic_mode', 'acf_relations' ],
					],
				]
		...
		$this->add_control(
			'parent_source',
			[
				'label' => __( 'Get from Parent (for template)', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				'child_source',
				[
					'label' => __( 'Get from Children (for template)', 'dynamic-content-for-elementor' ),
					'description' => __( 'Compared to myself-I take my children.', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => __( 'Same', 'dynamic-content-for-elementor' ),
					'label_off' => __( 'other', 'dynamic-content-for-elementor' ),
					'condition' => [
		...
		foreach ( $taxonomies as $tkey => $atax ) {
			if ( $tkey ) {
							$this->add_control(
								'terms_' . $tkey,
								[
									'label' => '<b>Include</b> Terms of ' . $tkey,
									'type' => 'ooo_query',
		...
		foreach ( $taxonomies as $tkey => $atax ) {
			if ( $tkey ) {
				$this->add_control(
					...
					[
						'label' => '<b>Exclude</b> Terms of ' . $tkey,
						'type' => 'ooo_query',
		...
		/*$this->add_control(
			...
			'options' => Helper::get_acf_fields('taxonomy'),
			'default' => '',
			'condition' => [
				'terms_from_acf' => 'yes',
			],
		...
		$this->add_control(
				...
				[
					'label' => __( 'Taxonomy (ACF)', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Select the Taxonomy', 'dynamic-content-for-elementor' ),
					'label_block' => true,
					'query_type' => 'acf',
		...
		$this->add_responsive_control(
					'image_rate',
					[
						'label' => __( 'Distribution (left, right, alternate)', 'dynamic-content-for-elementor' ),
						...
						'selectors' => [
							'{{WRAPPER}} .dce-acfposts_image' => 'width: {{SIZE}}% !important;',
							'{{WRAPPER}} .dce-acfposts_content' => 'width: calc( 100% - {{SIZE}}% ) !important;',
						],
						'condition' => [
							'image_position!' => '',
							'order_image' => '',
		...
		$this->add_control(
			'show_type',
			[
				'label' => __( 'Show Type', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'toggle' => false,
				'label_block' => false,
				'options' => [
			...
			[
				...
				'default' => [
					[
						...
						'list_html_content' => __( 'Image', 'dynamic-content-for-elementor' ),
						'_id' => 'sortimg',
					],
					[
						'list_name' => __( 'Date', 'dynamic-content-for-elementor' ),
						'list_html_content' => __( 'Date', 'dynamic-content-for-elementor' ),
						'_id' => 'sortdate',
					],
					[
					...
					[
						...
						'list_html_content' => __( 'Meta data', 'dynamic-content-for-elementor' ),
						'_id' => 'sortdata',
					],
					[
						'list_name' => __( 'Content', 'dynamic-content-for-elementor' ),
						'list_html_content' => __( 'Content', 'dynamic-content-for-elementor' ),
						'_id' => 'sortcont',
					],
					[
						'list_name' => __( 'Author', 'dynamic-content-for-elementor' ),
						'list_html_content' => __( 'Auhtor', 'dynamic-content-for-elementor' ),
						'_id' => 'sortauth',
					],
					[
						'list_name' => __( 'Type', 'dynamic-content-for-elementor' ),
						'list_html_content' => __( 'ACF Items', 'dynamic-content-for-elementor' ),
						'_id' => 'sorttype',
					],
					[
					...
					[
						...
						'list_html_content' => __( 'Read More', 'dynamic-content-for-elementor' ),
						'_id' => 'sortrem',
					],
				],
		...
		$this->add_control(
							...
							[
								...
								'description' => __( 'Transition effect between slides', 'dynamic-content-for-elementor' ),
								'type' => Controls_Manager::SELECT,
								'options' => [
									'slide' => __( 'Slide', 'dynamic-content-for-elementor' ),
									'fade' => __( 'Fade', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
		  ...
		  [
			  ...
			  'description' => __( 'The text separating the 2 numbers', 'dynamic-content-for-elementor' ),
			  'type' => Controls_Manager::TEXT,
			  'frontend_available' => true,
			  'default' => '/',
			  'condition' => [
		...
		$this->add_control(
		  ...
		  [
			  'label' => __( 'Color of the current number', 'dynamic-content-for-elementor' ),
			  'type' => Controls_Manager::COLOR,
			  'default' => '',
			  'selectors' => [
		...
		$this->add_control(
												...
												[
													...
													'description' => __( 'WatchSlidesProgress should be enabled. Enable this option and slides that are in viewport will have additional visible classes', 'dynamic-content-for-elementor' ),
													'type' => Controls_Manager::SWITCHER,
													'frontend_available' => true,
													'condition' => [
		...
		$this->add_responsive_control(
			'nuvolatta_move',
			[
				'label' => __( 'Horizontal Offset Arrow', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 50,
					'unit' => '%',
		...
		$this->add_responsive_control(
			'nuvolatta_size',
			[
				'label' => __( 'Arrow size', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 15,
					'unit' => 'px',
		...
		$this->add_control(
					...
					[
						...
						'options' => [
							'singular' => [
								'title' => __( 'Singular', 'dynamic-content-for-elementor' ),
								'icon' => 'fa fa-user',
							],
							'plural' => [
								'title' => __( 'Plural', 'dynamic-content-for-elementor' ),
								'icon' => 'fa fa-users',
							],
						],
						'default' => 'singular',
		...
		$this->start_controls_section(
			'section_acfitems',
			[
				'label' => __( 'Custom Fields', 'dynamic-content-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'templatemode_enable' => '',
					'native_templatemode_enable' => '',
...
$repeater->add_control(
		...
		$this->add_control(
			'acf_items',
			[
				'label' => __( 'Meta Items', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
		...
		foreach ( $taxonomies as $tkey => $atax ) {
			if ( $tkey ) {
				$this->add_control(
					...
					[
						'label' => __( 'Data Filters (Selected Terms)', 'dynamic-content-for-elementor' ), 
						'type' => 'ooo_query',
		...
		$this->add_control(
			'filters_acf',
			[
				'label' => __( 'Data Filters', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Select the field', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'acf',
				'object_type' => 'text,textarea,select,number,date_time_picker,date_picker,oembed,file,url,image,wysiwyg',
			]
		);
		$this->add_control(
			'all_filter',
		...
		$this->add_responsive_control(
			'hover_opacity',
			[
				'label' => __( 'Block Hover Opacity (%)', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->add_control(
			...
			[
				'label' => __( 'IN Animation effect', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SELECT,
		...
		$this->add_control(
					...
					[
						'label' => __( 'OUT Animation effect', 'dynamic-content-for-elementor' ),
						'type' => Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
										...
										[
											...
											'description' => 'Available only with [Layout > Position Top]',
											'type' => Controls_Manager::SLIDER,
											'size_units' => [ '%' ],
											'range' => [
												'%' => [
											...
											'selectors' => [
												'{{WRAPPER}}.image-acfposts-position-top .dce-acfposts_content' => 'width: {{SIZE}}% !important;',
											],
											'condition' => [
												'posts_style!' => 'timeline',
											],
		...
		$this->add_control(
			...
			[
				...
				//'default' => '',
				'selectors' => [
					'{{WRAPPER}} .dce-acfposts_content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
				'overflow_textzone_2',
				[
					'label' => __( 'Overflow Hidden', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'return_value' => 'hidden',
					'selectors' => [
						'{{WRAPPER}} .dce-acfposts_content' => 'overflow: {{VALUE}};',
					],
				]
		);
		$this->add_group_control(
		...
		$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .dce-post-type ' => 'color: {{VALUE}};',
						'{{WRAPPER}} .dce-post-type a' => 'color: {{VALUE}};',
					],
				]
		);
		$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .dce-post-type a:hover' => 'color: {{VALUE}};',
						],
					]
		);
		$this->add_group_control(
						...
						[
							...
							'selector' => '{{WRAPPER}} .dce-post-type',
		...
		$this->add_responsive_control(
						...
						[
							...
							'size_units' => [ 'px', '%' ],
							'selectors' => [
								'{{WRAPPER}} .dce-post-type' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							],
						]
		);
		$this->add_responsive_control(
							...
							[
								...
								'selectors' => [
									'{{WRAPPER}} .dce-post-type' => 'margin-bottom: {{SIZE}}{{UNIT}};',
								],
							]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Year over the block', 'dynamic-content-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'unic_date' => 'yes',
				],
		...
		$this->add_responsive_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .dce-post-date' => 'text-align: {{VALUE}};',
					],
				]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'arrows_horizontalspace',
			[
				'label' => __( 'Horizontal Shift Arrows', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
					'unit' => '%',
				...
				'selectors' => [
					'{{WRAPPER}} .slick-prev:not(.slick-disabled)' => 'left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .slick-next:not(.slick-disabled)' => 'right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( $settings['query_type'] == 'specific_posts' ) {
			...
			if ( $settings['acf_relationship_invert'] ) {
					...
					$relations_ids = get_post_meta( $id_page, $settings['acf_relationship'], true );
			}
			...
			/* if ($taxquery) {
			  if (count($taxquery) == 1) {
			  $tmp_tax = reset($taxquery);
			  if ($tmp_tax['taxonomy'] == 'category') {
			  $args['category'] = implode(',',$tmp_tax['terms']);
			  $taxquery = null;
			  }
			  }
			  } */
		...
		if ( $p_query->have_posts() ) :
			...
			<div class="acfposts-grid dce-posts-wrap<?php echo $styleClass . $classWrap . $stringSameHeightWrap . $stringInfiniteScroll; ?>"<?php echo $dataStyle . $dataGrid; ?>>
				...
				while ( $p_query->have_posts() ) :
					...
					<div data-dce-post-id="<?php echo $id_page; ?>" class="dce-post-item dce-post-item-<?php echo $id_page; ?> dce-elementor-<?php echo $id_page; ?> column-<?php echo $settings['columns_grid'] . $classItem; ?>  <?php echo $filters_string_class . $stringSameHeightItem . $wow_string . $hoverEffectsClass; ?>"<?php echo $wow_delay; ?>>
					...
					<nav class="infiniteScroll">
						<div class="page-load-status<?php echo $preview_mode; ?>">
							...
							if ( $settings['infiniteScroll_loading_type'] == 'text' ) {
								?>
								<div class="infinite-scroll-request status-text"><?php echo wp_kses_post( $settings['infiniteScroll_label_loading'] ); ?></div>
								<?php
							...
							<div class="infinite-scroll-last status-text"><?php echo wp_kses_post( $settings['infiniteScroll_label_last'] ); ?></div>
							<div class="infinite-scroll-error status-text"><?php echo wp_kses_post( $settings['infiniteScroll_label_error'] ); ?></div>
	...
	private function generate_date( $settings, $clss = null, $id_page = null ) {
		...
		switch ( $date_type ) {
			case 'modified':
				$date = '<span class="d1">' . get_the_modified_date( wp_kses_post( $settings['date_format'] ), $id_page ) . '</span>';
				if ( $settings['date_format_2'] != '' ) {
					$date2 = '<span> class="d2"' . get_the_modified_date( wp_kses_post( $settings['date_format_2'] ), $id_page ) . '</span>';
				}
				if ( $settings['date_format_3'] != '' ) {
					$date3 = '<span> class="d3"' . get_the_modified_date( wp_kses_post( $settings['date_format_3'] ), $id_page ) . '</span>';
				}
				break;

			case 'publish':
			default:
				$date = '<span class="d1">' . wp_kses_post( get_the_date( $settings['date_format'] ), $id_page ) . '</span>';
				if ( $settings['date_format_2'] != '' ) {
					$date2 = '<span class="d2">' . wp_kses_post( get_the_date( $settings['date_format_2'] ), $id_page ) . '</span>';
				}
				if ( $settings['date_format_3'] != '' ) {
					$date3 = '<span class="d3">' . wp_kses_post(  get_the_date( $settings['date_format_3'] ), $id_page ) . '</span>';
				}
				break;
		}
	...
	private function generate_acfitems( $settings, $id_page = null ) {
		...
		// DYNAMIC TAGS ACF by ELEMENTO PRO
		$acf_name = false;
				...
				switch ( $acfitem['link_to'] ) {
					case 'custom':
						if ( ! empty( $acfitem['link']['url'] ) ) {
							...
							if ( $acf_name ) {
									$link = Helper::get_post_meta( $id_page, $acf_name );
							}
						}
						break;
					case 'post':
	...
	protected function generate_image( $settings, $clss = null ) {
		...
		<div class="dce-acfposts_image<?php echo $clss; ?>">
			...
			if ( $settings['use_bgimage'] ) {
				...
				// in caso di img ?>
				<img src="<?php echo $image_url; ?>" title="<?php echo wp_kses_post( get_the_title() ); ?>" class="acfposts-image" />
				<?php
			} ?>
