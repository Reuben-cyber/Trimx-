...
class DCE_Widget_Repeater extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
		...
		$this->add_control(
			'deprecated',
			[
				'raw' => __( 'This widget is deprecated. You can continue to use it but we recommend that you use ACF Repeater widget new version instead, it\'s more fast.', 'dynamic-content-for-elementor' ),
		...
		foreach ( $repeaters as $arepeater => $arepeater_title ) {
			...
			$repeater_fields->add_control(
				...
				[
					'label' => __( 'HTML Label', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'' => 'None',
						'label' => 'label',
