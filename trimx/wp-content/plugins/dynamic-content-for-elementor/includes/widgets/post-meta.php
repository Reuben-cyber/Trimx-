	...
	protected function _register_controls_content() {
		...
		$this->add_control(
				...
				[
					...
					'query_type'    => 'metas',
					'object_type'   => 'post',
					'default' => '_wp_page_template',
				]
		);

		$this->add_control(
				'dce_meta_array', [
					'label' => __( 'Multiple postmeta', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Enable if post has many postmeta with same meta_key.', 'dynamic-content-for-elementor' ),
				]
		);
		$this->add_control(
		...
		$this->add_control(
				'dce_meta_raw', [
					...
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Use value stored in postmeta, without any plugin modification.', 'dynamic-content-for-elementor' ),
				]
		);
		$this->add_control(
				'dce_meta_custom', [
		...
		$this->add_control(
			'dce_meta_multiple_id', [
				...
				'toggle' => false,
				'description' => __( 'Obtain object data from ID of the selected type. Enable if Meta data is the ID', 'dynamic-content-for-elementor' ),
				'condition' => [
		...
		$this->add_control(
				...
				[
					'label' => __( 'Prevent Scroll', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'selectors' => [
		...
		$this->add_control(
				...
				[
					...
					'placeholder' => __( 'https://your-link.com', 'dynamic-content-for-elementor' ),
					'default' => [
						'url' => '[option:home]',
					],
					'condition' => [
						'dce_meta_type' => 'text',
						'dce_meta_link' => 'custom',
					],
				]
		);
		$this->end_controls_section();
		...
		$this->add_control(
				...
				[
					...
					'options' => [
						...
						'attachment' => __( 'Attachment Caption', 'dynamic-content-for-elementor' ),
						'custom' => __( 'Custom Caption', 'dynamic-content-for-elementor' ),
					],
					'default' => 'none',
				]
		);
		$this->add_control(
				...
				[
					'label' => __( 'Custom Caption', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'default' => '',
					'placeholder' => __( 'Enter your image caption', 'dynamic-content-for-elementor' ),
					'condition' => [
		...
		$this->add_control(
				...
				[
					...
					'options' => [
						'' => __( 'None', 'dynamic-content-for-elementor' ),
						'file' => __( 'Media File', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
				...
				[
					...
					'default' => __( 'Click here', 'dynamic-content-for-elementor' ),
					'placeholder' => __( '[META_VALUE], [META_VALUE:title], [META_VALUE:get_the_title]', 'dynamic-content-for-elementor' ),
					'description' => __( 'Can use a mix of text, Tokens and META_VALUE data', 'dynamic-content-for-elementor' ),
				]
		);
		$this->add_control(
				...
				[
					...
					'placeholder' => __( '[META_VALUE], [META_VALUE:url], [META_VALUE|get_permalink]', 'dynamic-content-for-elementor' ),
					'default' => [
						'url' => '#',
					],
					'description' => __( 'Can use a mix of text, Tokens and META_VALUE data', 'dynamic-content-for-elementor' ),
		...
		$this->start_controls_section(
				'dce_meta_section_fallback', [
					'label' => __( 'Empty field behaviour', 'dynamic-content-for-elementor' ),
				]
		);
		$this->add_control(
				'dce_meta_fallback', [
		...
		$this->add_control(
				'array_css_classes',
				[
					'label' => __( 'CSS Classes', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'dynamic' => [
						'active' => true,
					],
					//'prefix_class' => '',
					'title' => __( 'Add your custom class WITHOUT the dot. e.g: my-class', 'dynamic-content-for-elementor' ),
				]
		);
		$this->end_controls_section();
	}
		...
		if ( ! empty( $meta_values ) ) {
			...
			foreach ( $meta_values as $mkey => $meta_value ) {
				...
				if ( ! $settings['dce_meta_raw'] ) {
					$meta_value_enchanted = Helper::get_post_meta( $post_id, $meta_key, true, true, false );
					...
					case 'time_picker':
						...
						if ( $settings['dce_meta_date_format_source'] ) {
							if ( $settings['dce_meta_date_format_source'] == 'timestamp' ) {
								...
								if ( is_array( $meta_value ) ) { // ACF Repeater
				...
				$meta_html = Tokens::do_tokens( $meta_html ); // if text contain tokens
