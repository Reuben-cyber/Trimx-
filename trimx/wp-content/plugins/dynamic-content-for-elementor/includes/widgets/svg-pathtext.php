...
class DCE_Widget_Svg_PathText extends DCE_Widget_Prototype {
	...
	protected function _register_controls_content() {
		$this->start_controls_section(
			'section_pathText', [
				'label' => __( 'pathText', 'dynamic-content-for-elementor' ),
			]
		);
		$this->add_control(
			'svgpathtext_text', [
				...
				'default' => __( 'Abcdefg', 'dynamic-content-for-elementor' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			'svgpathtext_path', [
				'label' => __( 'Path', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'startOffset',
			[
				'label' => __( 'Start Offset', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => '%',
		...
		$this->add_control(
			'circleRadius',
			[
				'label' => __( 'Circle Radius', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 200,
				...
				'condition' => [
					'svgpathtext_path' => 'circle',
				],
			]
		);
		$this->add_control(
		  'pathtext_path_custom',
		  [
			  'label'   => __( 'Custom path (d)', 'dynamic-content-for-elementor' ),
			  'type'    => Controls_Manager::TEXTAREA,
			  'default' => 'M 10,90 Q 100,15 200,70 Q 340,140 400,30',
			  'condition' => [
				  'svgpathtext_path' => 'custom',
			  ],
		  ]
		);
		$this->add_control(
			'show_path', [
				'label' => __( 'Show path', 'dynamic-content-for-elementor' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} text#pathtext-text',
				'exclude' => [
					'line_height',
					'letter-spacing',
				],
		...
		$this->add_control(
			'length_adjust_spacing', [
				'label' => __( 'Length Adjust Spacing', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
		...
		$this->add_control(
			'textLength',
			[
				'label' => __( 'Text Length (only Firefox)', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
		...
		$this->add_control(
			'textSpacing',
			[
				'label' => __( 'Text Spacing (Other browser)', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
				...
				'selectors' => [
					'{{WRAPPER}} text#pathtext-text' => 'letter-spacing: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'length_adjust_spacing' => 'yes',
				],
		...
		$this->add_control(
			'text_color', [
				...
				'default' => '#000000',
				/*'selectors' => [
					'{{WRAPPER}} text#pathtext-text, ' => 'color: {{VALUE}};',
				],*/
		...
		$this->add_control(
			'path_color', [
				'label' => __( 'Path color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#e20613',
				'selectors' => [
					'{{WRAPPER}} path#pathtext-path, ' => 'stroke: {{VALUE}};',
				],
				'condition' => [
					'show_path' => 'yes',
				],
	...
	protected function render() {
	   ...
	   <svg id="dce-svg-<?php echo $widgetId; ?>" class="dce-svg-pathtext" version="1.1" xmlns="http://www.w3.org/2000/svg"  width="100%" height="100%"  viewBox="0 0 <?php echo $viewBoxW; ?> <?php echo $viewBoxH; ?>" preserveAspectRatio="xMidYMid meet" xml:space="preserve">

			<?php if ( ! $show_path ) { ?>
				<defs>
			<?php } ?>
			<path id="pathtext-path-<?php echo $widgetId; ?>" d="<?php echo $path; ?>" fill="none" stroke="<?php echo $path_color; ?>" />
			<?php if ( ! $show_path ) { ?>
				</defs>
			<?php } ?>
			...
			<text id="pathtext-text" fill="<?php echo $text_color; ?>"<?php echo $length_adjust_spacing; ?>><textPath xlink:href="#pathtext-path-<?php echo $widgetId; ?>" startOffset="<?php echo $startOffset; ?>" method="stretch" spacing="auto"><tspan><?php echo $pathtext_text; ?></tspan></textPath></text>
		</svg>
		<?php
		echo '</div>';
	}
