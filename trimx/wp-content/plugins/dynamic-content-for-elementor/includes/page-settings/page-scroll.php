...
class DCE_Document_Scrolling extends DCE_Document_Prototype {
	...
	public static function get_description() {
		return __( 'Scrolling settings', 'dynamic-content-for-elementor' );
	}
	...
	private function add_controls( $document, $args ) {
		...
		$document->add_control(
				...
				[
					'label' => __( 'Effects Scroll', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'render_type' => 'template',
					'frontend_available' => true,
					'separator' => 'before',
		...
		$document->add_control(
				'enable_scrollify',
				[
					'label' => __( 'Snap Scroll', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'separator' => 'before',
					'condition' => [
		...
		$document->add_control(
				...
				[
					...
					'options' => [
						...
						'shamso' => __( 'Dots', 'dynamic-content-for-elementor' ), // Shamso
						'xusni' => __( 'Bars', 'dynamic-content-for-elementor' ), // Xusni oppure Beca
						'etefu' => __( 'Vertical Bars', 'dynamic-content-for-elementor' ), // Etefu
						'magool' => __( 'Lines (without title)', 'dynamic-content-for-elementor' ), // Magool
						'ubax' => __( 'Squares', 'dynamic-content-for-elementor' ), // Ubax
						'timiro' => __( 'Circles', 'dynamic-content-for-elementor' ), // Timiro
						'ayana' => __( 'Circles line (SVG)', 'dynamic-content-for-elementor' ), // Ayana
						'desta' => __( 'Triangles', 'dynamic-content-for-elementor' ), // Desta
						'totit' => __( 'Icons', 'dynamic-content-for-elementor' ), // Totit
					],
					'render_type' => 'template',
					'frontend_available' => true,
					'condition' => [
		...
		$document->add_control(
				...
				[
					'label' => __( 'Show section\'s title', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'separator' => 'before',
					'default' => 'none',
					'options' => [
		...
		$document->add_control(
				...
				[
					...
					'show_label' => false,
					'default' => '',
					'raw' => __( 'You must write the class ID on the sections first and then apply this option to see the result. The name on the ID must not contain spaces or use (-) or (_) to separate words, in the result they will be converted into spaces.', 'dynamic-content-for-elementor' ),
		...
		$document->add_control(
				'responsive_snapScroll', [
					'label' => __( 'Apply Snap Scroll on:', 'dynamic-content-for-elementor' ),
					'description' => __( 'Responsive mode will take place on preview or live pages only, not while editing in Elementor.', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT2,
					'multiple' => true,
					'separator' => 'before',
		...
		$document->add_control(
				...
				[
					'label' => __( 'Inertia Scroll', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'separator' => 'before',
					'frontend_available' => true,
					'condition' => [
		...
		$document->add_control(
				...
				[
					...
					'show_label' => false,
					'default' => '',
					'raw' => __( 'Scrolling management compromises various elements of the page (not just Elementor). In order to function correctly and obtain the transformations, it is necessary to indicate the CSS selectors of the theme used. By default we indicate the elements for OceanWP theme.', 'dynamic-content-for-elementor' ),
		...
		$document->add_control(
				'automatic_wrapper',
				[
					'label' => __( 'Automatic Wrapper', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'render_type' => 'template',
					'condition' => [
		...
		$document->add_control(
				'coefSpeed_inertiaScroll', [
					'label' => __( 'Speed coefficient', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SLIDER,
					'separator' => 'before',
					'default' => [
						'size' => '0.05',
		...
		$document->add_control(
				'directionScroll',
				[
					'label' => __( 'Scroll Direction', 'dynamic-content-for-elementor' ),
		...
		$document->add_control(
				'responsive_inertiaScroll', [
					'label' => __( 'Apply Inertia Scroll on:', 'dynamic-content-for-elementor' ),
					'description' => __( 'Responsive mode will take place on preview or live pages only, not while editing in Elementor.', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SELECT2,
					'multiple' => true,
					'separator' => 'before',
