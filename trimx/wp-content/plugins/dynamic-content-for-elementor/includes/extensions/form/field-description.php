		...
		if ( $element->get_name() == 'form' ) {
			...
			if ( $control_id == 'form_fields' ) {
				...
				$control_data['fields']['field_description'] = array(
					...
					'label' => __( 'Description HTML', 'dynamic-content-for-elementor' ),
			...
			if ( $control_id == 'field_background_color' ) {
				$element->add_control(
					...
					[
						'label' => __( 'Description Color', 'dynamic-content-for-elementor' ),
				...
				$element->add_control(
					...
					[
						'label' => __( 'Label Description Color', 'dynamic-content-for-elementor' ),
						'type' => Controls_Manager::COLOR,
						'selectors' => [
				...
				$element->add_control(
					...
					[
						'label' => __( 'Label Description Background Color', 'dynamic-content-for-elementor' ),
						'type' => Controls_Manager::COLOR,
						'selectors' => [
