...
class CustomValidation extends DCE_Extension_Prototype {
	...
	public function add_controls_to_form( $widget ) {
		...
		$widget->add_control(
			...
			[
				'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'PHP Validation', 'dynamic-content-for-elementor' ),
		...
		$widget->add_control(
			...
			[
				'label' => __( 'PHP Validation Code', 'dynamic-content-for-elementor' ),
