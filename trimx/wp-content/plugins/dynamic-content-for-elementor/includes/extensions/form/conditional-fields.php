...
class DCE_Extension_Form_Visibility extends DCE_Extension_Prototype {
								...
								(function ($) {
									var <?php echo $jkey; ?> = function ($scope, $) {
										...
										<?php if ( $afield['field_type'] == 'step' ) { ?>
											...
											?>
											<?php if ( empty( $afield['dce_field_visibility_render'] ) ) {
												?>jQuery('<?php echo $afield['element_css_group']; ?>').<?php echo $afield['dce_field_visibility_mode']; ?>();<?php
											} ?>
											...
											<?php if ( $afield['field_type'] == 'step' ) {
												...
												?>
												<?php if ( empty( $afield['dce_field_visibility_render'] ) ) {
													?>jQuery('<?php echo $afield['element_css_group']; ?>').<?php echo $display_init; ?>();<?php
												} ?>
	...
	public static function _add_to_form( Controls_Stack $element, $control_id, $control_data, $options = [] ) {
		...
		if ( $element->get_name() == 'form' && $control_id == 'form_fields' ) {
			...
			$control_data['fields']['dce_field_visibility_deprecated'] = array(
				'name' => 'dce_field_visibility_deprecated',
			...
			$control_data['fields']['dce_field_visibility_field'] = array(
				...
				'placeholder' => __( 'name', 'dynamic-content-for-elementor' ),
				'tabs_wrapper' => 'form_fields_tabs',
				'inner_tab' => 'form_fields_visibility_tab',
			...
			$control_data['fields']['dce_field_visibility_field_multiple'] = array(
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'name,message', 'dynamic-content-for-elementor' ),
				'description' => __( 'Separate each field ID it with a comma', 'dynamic-content-for-elementor' ),
				'condition' => array(
					'dce_field_visibility_mode!' => 'visible',
			...
			$control_data['fields']['dce_field_visibility_operator'] = array(
				...
				'options' => Helper::get_string_comparison(),
				'default' => 'equal_to',
				'tab' => 'visibility',
				'tabs_wrapper' => 'form_fields_tabs',
				'inner_tab' => 'form_fields_visibility_tab',
			...
			$control_data['fields']['dce_field_visibility_value_multiple'] = array(
				...
				'tabs_wrapper' => 'form_fields_tabs',
				'inner_tab' => 'form_fields_visibility_tab',
				'description' => __( 'One value per line. Type them in the same order of the selected fields', 'dynamic-content-for-elementor' ),
				'condition' => array(
					'dce_field_visibility_mode!' => 'visible',
					'dce_field_visibility_multiple' => 'yes',
				),
