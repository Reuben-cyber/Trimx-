...
class DynamicSelect extends \ElementorPro\Modules\Forms\Fields\Field_Base {
	...
	public function update_controls( $widget ) {
		...
		$field_controls = [
			'dce_select_field_id' =>
			[
				'name' => 'dce_select_field_id',
				'label' => __( 'Reference Field ID', 'dynamic-content-for-elementor' ),
				'label_block' => true,
			...
			'dce_dynamic_select_options' => [
				'name' => 'dce_dynamic_select_options',
				'label' => __( 'Options', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => '',
				'description' => __( 'Options are written as a normal select field. They are grouped according to the reference field value with sections starting with this value inside square brackets: <code>[value]</code>.', 'dynamic-content-for-elementor' ),
				'condition' => [
					'field_type' => $this->get_type(),
				],
				'tab' => 'content',
