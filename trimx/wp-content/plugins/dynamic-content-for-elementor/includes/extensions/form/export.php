	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
				'dce_form_export_headers', [
					...
					'default' => [
						[
							'dce_form_export_header_key' => 'Connection',
							'dce_form_export_header_value' => 'keep-alive',
						],
					],
					'prevent_empty' => false,
				]
		...
		$widget->add_control(
				'dce_form_pdf_error', [
					...
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'If the remote request fails (not response code 200) then an error is going to be displayed', 'dynamic-content-for-elementor' ),
					'default' => 'yes',
				]
		);
