...
class ConditionalFieldsV2 extends DCE_Extension_Prototype {
	...
	protected function add_actions() {
		...
		add_action( 'elementor_pro/forms/validation',
					[ $this, 'validation' ], 1000, 2 );
	}

	public function update_validation_controls( $widget ) {
		$widget->start_controls_section(
			'section_conditional_validation',
			[
				'label' => '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __( 'Conditional Validation', 'dynamic-content-for-elementor' ),
			]
		);
		...
		$repeater->add_control(
			'disabled', [
				'label' => __( 'Disable', 'dynamic-content-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
			]
		);
		$repeater->add_control(
			'expression', [
				'label' => __( 'Expression', 'dynamic-content-for-elementor' ),
		...
		$repeater->add_control(
			'error_message', [
				...
				'default' => __( 'Form Validation Error', 'dynamic-content-for-elementor' ),
		...
		$repeater->add_control(
			'error_field_id', [
				'label' => __( 'Field ID to attach the error to (optional)', 'dynamic-content-for-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'hide_submit', [
				'label' => __( 'Also hide the Submit button if the condition is not satisfied', 'dynamic-content-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_block' => true,
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Conditional Validations', 'dynamic-content-for-elementor' ),
				...
				'title_field' => 'Condition {{ error_field_id }}',
				'hide_submit' => 'no',
			]
		);
