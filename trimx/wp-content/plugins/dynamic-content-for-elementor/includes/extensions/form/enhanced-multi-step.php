...
class DCE_Extension_Form_Step extends DCE_Extension_Prototype {
	...
	public function add_control_section_to_steps( $element, $args ) {
		...
		$element->add_control(
				'dce_step_legend',
				[
					'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'Use Label as Legend', 'dynamic-content-for-elementor' ),
		...
		$element->add_control(
				'dce_step_show',
				[
					'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'Show All steps', 'dynamic-content-for-elementor' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
				]
		);
		...
		$element->add_control(
				'dce_step_scroll',
				[
					'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'Scroll to Top on Step change', 'dynamic-content-for-elementor' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'condition' => [
						'dce_step_show' => '',
					],
		...
		$element->add_control(
				'dce_step_summary',
				[
					'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'Step Summary', 'dynamic-content-for-elementor' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
	...
	public function add_control_section_to_form( $element, $args ) {
		...
		$element->start_controls_section(
				...
				[
					'label' => __( 'Steps Legend', 'dynamic-content-for-elementor' ),
		...
		$element->start_controls_section(
				...
				[
					'label' => __( 'Steps Summary', 'dynamic-content-for-elementor' ),
					'tab' => \Elementor\Controls_Manager::TAB_STYLE,
					'condition' => [
						'dce_step_summary!' => '',
						'dce_step_show' => '',
		...
		$element->add_control(
				...
				[
					'label' => __( 'Step', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				]
		);
		...
		$element->start_controls_tab(
				...
				[
					'label' => __( 'Filled', 'dynamic-content-for-elementor' ),
				]
		);
		$element->add_control(
		...
		$element->add_control(
				...
				[
					'label' => __( 'Label Color', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'separator' => 'before',
					'selectors' => [
		...
		$element->add_control(
				...
				[
					'label' => __( 'Submit Button', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				]
		);
