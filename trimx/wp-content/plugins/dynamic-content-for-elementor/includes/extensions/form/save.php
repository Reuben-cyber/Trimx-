...
class DCE_Extension_Form_Save extends \ElementorPro\Modules\Forms\Classes\Action_Base {
	...
	public function get_label() {
		return '<span class="color-dce icon icon-dyn-logo-dce pull-right ml-1"></span> ' . __( 'Save', 'dynamic-content-for-elementor' );
	}
	...
	public function register_settings_section( $widget ) {
		...
		if ( \Elementor\Plugin::$instance->editor->is_edit_mode()
			...
			$widget->add_control(
				'admin_notice', [
					...
					'raw' => '<div class="elementor-panel-alert elementor-panel-alert-warning">' . __( 'You will need administrator capabilities to edit this action.', 'dynamic-content-for-elementor' ) . '</div>',
				]
			);
		...
		if ( ! get_option( 'users_can_register' ) ) {
			$widget->add_control('user_can_register_notice', [
				'type' => Controls_Manager::RAW_HTML,
				'raw' => '<div class="elementor-panel-alert elementor-panel-alert-warning">' . __( 'User registration is currently disabled. Please enable it in WordPress Settings - General - Membership.', 'dynamic-content-for-elementor' ) . '</div>',
				'condition' => [
		...
		$widget->add_control(
				'dce_form_save_ignore_empty', [
					...
					'description' => __( 'Do not save the field if its value is empty to limit DB size consumption', 'dynamic-content-for-elementor' ),
				]
		);
		$widget->add_control(
				'dce_form_save_file', [
					...
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Create a Media and save its ID instead of the URL', 'dynamic-content-for-elementor' ),
				]
		);
		$widget->add_control(
				'dce_form_save_array', [
					'label' => __( 'Save Multiple as Array', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Save Files, Select and Checkboxes submitted values as Array instead of a comma to separate values string', 'dynamic-content-for-elementor' ),
				]
		);

		$widget->add_control(
				'dce_form_save_redirect', [
					'label' => __( 'Redirect to', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Go to new object page after saving it', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type!' => 'option',
					],
				]
		);
		...
		$widget->add_control(
				'dce_form_save_override', [
					'label' => __( 'Update existent data', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'All data will be updated and all previous data will be overwritten', 'dynamic-content-for-elementor' ),
				]
		);

		$widget->add_control(
				'dce_form_save_type_obj_id', [
					'label' => __( 'ID to update', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::NUMBER,
					'label_block' => true,
					'description' => __( 'ID of the Object to update or leave it empty for Current.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_override!' => '',
					],
				]
		...
		$widget->add_control(
				'dce_form_save_type_post_post', [
					'label' => __( 'Find Post to update', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Select a Post or leave it empty for the Current one', 'dynamic-content-for-elementor' ),
					'label_block' => true,
					'query_type' => 'posts',
					'description' => __( 'Search Post by Title or leave it empty for Current Post.', 'dynamic-content-for-elementor' ),
					'condition' => [
		...
		$widget->add_control(
				'dce_form_save_type_user_user', [
					'label' => __( 'Find User to update', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Find a User', 'dynamic-content-for-elementor' ),
					'label_block' => true,
					'query_type' => 'users',
					'description' => __( 'Search User or leave it empty for Current User.', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'user',
						'dce_form_save_override!' => '',
						'dce_form_save_type_obj_id' => '',
		...
		$widget->add_control(
				'dce_form_save_type_term_term', [
					'label' => __( 'Find Term to update', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
					'placeholder' => __( 'Find a Term', 'dynamic-content-for-elementor' ),
					'label_block' => true,
					'query_type' => 'terms',
					'description' => __( 'Search Term or leave it empty for Current Term.', 'dynamic-content-for-elementor' ),
					'condition' => [
		...
		$widget->add_control(
				'dce_form_save_metas', [
					'label' => __( 'Form fields to save as meta', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'placeholder' => 'name,message',
					'description' => __( 'Type here the Field IDs with a comma. The Field ID must have the same name of the meta. Leave it empty to save all fields.', 'dynamic-content-for-elementor' ),
					'label_block' => 'true',
				]
		);
		...
		$widget->add_control(
				'dce_form_save_type_post_title', [
					...
					'type' => Controls_Manager::TEXT,
					'default' => __( 'Form Entry by', 'dynamic-content-for-elementor' ) . ' [field id="name"]',
					'description' => __( 'You can use static text, field shortcode, tokens or mixed. Leave it empty for random values', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'post',
					],
					'label_block' => 'true',
		...
		$widget->add_control(
				'dce_form_save_type_post_content', [
					...
					'description' => __( 'Can use static text, field shortcode, tokens or mixed', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'post',
					],
					'label_block' => 'true',
		...
		$widget->add_control(
				'dce_form_save_type_post_term',
				[
					'label' => __( 'Post Term', 'dynamic-content-for-elementor' ),
					'type' => 'ooo_query',
		...
		$widget->add_control(
				'dce_form_save_type_post_status', [
					...
					'options' => [
						...
						'private' => [
							'title' => __( 'Private', 'dynamic-content-for-elementor' ),
							'icon' => 'fa fa-shield',
						],
						'draft' => [
		...
		$widget->add_control(
				'dce_form_save_type_user_username', [
					'label' => __( 'UserName', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'description' => __( 'Use field Shortcode for UserName or leave it empty for a random value', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'user',
						'dce_form_save_override' => '',
					],
		...
		$widget->add_control(
				'dce_form_save_type_user_email', [
					'label' => __( 'User Email', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
				'dce_form_save_type_user_pass', [
					'label' => __( 'User Password', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
				'dce_form_save_type_user_login', [
					...
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'The new user will be automatically logged in and its data will be available when the next page is loaded', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'user',
						'dce_form_save_override' => '',
					],
		...
		$widget->add_control(
				'dce_form_save_type_user_error', [
					'label' => __( 'User registration Error Message', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
				'dce_form_save_type_user_error_stop', [
					'label' => __( 'Stop Actions on Error', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'description' => __( 'Stop Dynamic Content for Elementor form actions (it doesn’t stop Elementor actions) on Error,  username or email are not valid', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'user',
						'dce_form_save_override' => '',
					],
		...
		$widget->add_control(
				'dce_form_save_type_term_name', [
					...
					'description' => __( 'Can use static text, field Shortcode, Token or mixed. Leave it empty for random values', 'dynamic-content-for-elementor' ),
					'condition' => [
						'dce_form_save_type' => 'term',
					],
					'label_block' => 'true',
	...
	private function dce_elementor_form_save( $record, $settings = null, $ajax_handler = null ) {
		$obj_id = false;
		$fields = array();
		if ( is_object( $record ) ) {
			// from add action
		...
		switch ( $settings['dce_form_save_type'] ) {
			...
			case 'user':
				if ( ! get_option( 'users_can_register' ) ) {
					$ajax_handler->add_error_message( __( 'User registration is currently disabled, sorry.', 'dynamic-content-for-elementor' ) );
					return;
				}
				$settings['dce_form_save_type_user_username'] = sanitize_title( Helper::get_dynamic_value( $settings['dce_form_save_type_user_username'], $fields ) );
			...
			if ( ! get_current_user_id() ) {
				if ( $settings['dce_form_save_type_user_login'] ) {
					...
					$user = wp_signon(array(
						'user_login' => $db_ins['user_email'],
						'user_password' => $db_ins['user_pass'],
					));
				}
			}
		}
