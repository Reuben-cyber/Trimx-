...
class DCE_Extension_Form_Signature extends \ElementorPro\Modules\Forms\Fields\Field_Base {
	...
	public function update_controls( $widget ) {
		...
		$field_controls = [
			...
			[
				'name' => 'signature_jpeg',
				'label' => __( 'Transmit using JPEG', 'dynamic-content-for-elementor' ),
				'description' => __( 'Use this option to if the signature does not appear in the PDF.', 'dynamic-content-for-elementor' ),
