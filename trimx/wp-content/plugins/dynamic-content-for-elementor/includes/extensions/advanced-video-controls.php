...
class DCE_Extension_Video extends DCE_Extension_Prototype {
	...
	public function add_control_section_to_video( $element, $args ) {
		...
		$element->add_control(
				...
				[
					'label' => '<span class="color-dce icon icon-dyn-logo-dce"></span> ' . __( 'Custom controls', 'dynamic-content-for-elementor' ),
		...
		$element->add_control(
				'dce_video_bgcolor',
				[
					'label' => __( 'Backgrounds buttons Controls', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		...
		$element->add_control(
				...
				[
					'label' => __( 'Controls Color Hover', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		...
		$element->add_control(
				...
				[
					'label' => __( 'Controls Background Color', 'dynamic-content-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
	...
	public function _render_video( $content, $widget ) {
		if ( $widget->get_name() == 'video' ) {
			...
			if ( $settings['dce_video_custom_controls'] ) {
				wp_enqueue_script( 'dce-plyr-js', DCE_URL . 'assets/lib/plyr/plyr.min.js', [], DCE_VERSION, true );
				wp_enqueue_script( 'dce-advancedvideo', DCE_URL . 'assets/js/advanced-video.js', [], DCE_VERSION, true );
				wp_enqueue_style( 'plyr', DCE_URL . 'assets/lib/plyr/plyr.css', [], DCE_VERSION );
			}
		}
		return $content;
	}
