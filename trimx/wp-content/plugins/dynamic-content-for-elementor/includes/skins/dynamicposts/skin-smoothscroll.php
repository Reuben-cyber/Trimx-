...
class Skin_Smoothscroll extends Skin_Base {
	...
	public function register_additional_smoothscroll_controls() {
		...
		$this->start_controls_section(
			'section_smoothscroll', [
				'label' => '<i class="dynicon eicon-parallax"></i> ' . __( 'Smoothscroll', 'dynamic-content-for-elementor' ),
		...
		$this->add_responsive_control(
			'smoothscroll_width', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-smoothscroll-container .dce-smoothscroll-wrapper .dce-smoothscroll-item' => 'width: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			'smoothscroll_alternate', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-smoothscroll-container .dce-smoothscroll-wrapper .dce-smoothscroll-item:nth-child(even)' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .dce-smoothscroll-container .dce-smoothscroll-wrapper .dce-smoothscroll-item:nth-child(odd)' => 'margin-left: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			'smoothscroll_rowspace', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-smoothscroll-container .dce-smoothscroll-wrapper .dce-smoothscroll-item:not(:first-child)' => 'margin-top: {{SIZE}}{{UNIT}};',
		...
		// Padding sopra /sotto
		$this->add_responsive_control(
			'smoothscroll_padding', [
				'label' => __( 'Padding of content', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vh' ],
				'default' => [
					'size' => '',
				...
				'selectors' => [
					'{{WRAPPER}} .dce-smoothscroll-container .dce-smoothscroll-wrapper' => 'padding: {{SIZE}}{{UNIT}} 0 {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			'smoothscroll_content_translatey', [
				'label' => __( 'Translate Y', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			'section_style_smoothscroll',
			[
				'label' => __( 'Smoothscroll', 'dynamic-content-for-elementor' ),
