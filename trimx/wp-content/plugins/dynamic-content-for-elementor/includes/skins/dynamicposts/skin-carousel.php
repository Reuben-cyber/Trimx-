...
class Skin_Carousel extends Skin_Base {
	...
	public $depended_scripts = [ 'dce-dynamicPosts-carousel', 'dce-dynamicPosts-dualcarousel', 'dce-jquery-match-height' ];

	public $depended_styles = [ 'dce-dynamicPosts-grid', 'dce-dynamicPosts-carousel', 'dce-swiper' ];
	...
	public function register_additional_carousel_controls() {
		...
		$this->add_control(
			'match_height',
			[
				'label' => __( 'Match Height', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_responsive_control(
			'initialSlide', [
				'label' => __( 'Initial Slide', 'dynamic-content-for-elementor' ),
				'description' => __( 'Index number of initial slide', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 0,
				'tablet_default' => '',
				'mobile_default' => '',
		...
		$this->add_control(
			'useNavigation', [
				...
				'description' => __( 'Use the navigation arrows.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_responsive_control(
			'vert_navigation_shift', [
				'label' => __( 'Vertical Shift', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '',
					'unit' => 'px',
		...
		$this->add_control(
			'usePagination', [
				...
				'description' => __( 'Use the slide progression display system.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'dynamicBullets', [
				'label' => __( 'Dynamic Bullets', 'dynamic-content-for-elementor' ),
				'description' => __( 'Enable it if you use bullets pagination with a lot of slides. So it will keep only few bullets visible at the same time.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
				'condition' => [
		...
		$this->add_control(
			'useScrollbar', [
				...
				'description' => __( 'Use a scrollbar that display navigation', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_on' => __( 'Yes', 'dynamic-content-for-elementor' ),
				'label_off' => __( 'No', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'centeredSlidesBounds', [
				...
				'description' => __( 'If true, active slide will be centered without adding gaps at the beginning and end of slider. Required centeredSlides: true. Not intended to be used with loop or pagination.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'condition' => [
					$this->get_control_id( 'effects!' ) => [ 'cube', 'flip' ],
		...
		$this->add_control(
			'reverseDirection', [
				...
				'description' => __( 'Autoplay in reverse direction.', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'separator' => 'before',
			]
