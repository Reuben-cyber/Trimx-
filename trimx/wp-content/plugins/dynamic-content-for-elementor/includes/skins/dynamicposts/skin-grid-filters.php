...
class Skin_Grid_Filters extends Skin_Grid {
	...
	public function register_additional_filters_controls() {
		...
		$this->add_control(
			'filter_hide_empty', [
				'label' => __( 'Empty terms', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
	...
	protected function register_style_controls() {
		...
		$this->add_control(
			'filters_color_separator', [
				'label' => __( 'Separator Filters Color', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dce-filters .filters-separator' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				'name' => 'typography_filters_separator',
				'label' => __( 'Typography Separator', 'dynamic-content-for-elementor' ),
				'selector' => '{{WRAPPER}} .dce-filters .filters-separator',
			]
		);
		$this->add_responsive_control(
			'filters_padding_items', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-filters .filters-separator' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'filters_margin', [
				...
				'selectors' => [
					'{{WRAPPER}} .dce-filters' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			'filters_move_separator', [
				'label' => __( 'Vertical Shift Separator', 'dynamic-content-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'px',
				...
				'selectors' => [
					'{{WRAPPER}} .dce-filters .filters-separator' => 'top: {{SIZE}}{{UNIT}}; position: relative;',
				],
			]
		);
		$this->end_controls_section();
