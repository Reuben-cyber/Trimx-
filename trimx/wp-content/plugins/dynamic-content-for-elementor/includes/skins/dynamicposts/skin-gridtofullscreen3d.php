...
class Skin_Gridtofullscreen3d extends Skin_Grid {
	...
	public $depended_styles = [ 'dce-dynamicPosts-grid', 'dce-dynamicPosts-gridtofullscreen3d' ];
	...
	public function render_fullview_item() {
		...
		<div class="fullview__item">
				<h2 class="fullview__item-title"><?php get_the_title() ? wp_kses_post( the_title() ) : the_ID(); ?></h2>
