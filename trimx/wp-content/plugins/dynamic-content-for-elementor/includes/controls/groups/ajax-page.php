...
class DCE_Group_Control_Ajax_Page extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['enabled'] = [
			'label' => __( 'Ajax Page', 'dynamic-content-for-elementor' ),
		...
		$fields['change_url'] = [
			'label' => __( 'Force URL update', 'dynamic-content-for-elementor' ),
			'type' => Controls_Manager::SWITCHER,
			'default' => 'yes',
			'return_value' => 'yes',
			'frontend_available' => true,
		...
		$fields['bg_modal'] = [
			...
			'selectors' => [
				'body.modal-p-on.modal-p-{{ID}} .wrap-p .modal-p' => 'background-color: {{VALUE}};',
			],
			'default' => '#FFF',
			'separator' => 'before',
			'condition' => [
