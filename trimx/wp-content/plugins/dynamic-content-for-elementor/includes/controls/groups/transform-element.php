...
class DCE_Group_Control_Transform_Element extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['transform'] = [
			'label' => _x( 'Transformations', 'Transform Control', 'dynamic-content-for-elementor' ),
			'type' => 'transforms',
			'responsive' => true,
			'render_type' => 'ui',
			'default' => [
		...
		$controls['transform-origin'] = [
			'label' => _x( 'Transform origin', 'Transform-origin x/y Control', 'dynamic-content-for-elementor' ),
			'type' => 'xy_positions',
			'responsive' => true,
			'render_type' => 'ui',
			'condition' => [
		...
		$controls['perspective-origin'] = [
			'label' => _x( 'Perspective origin', 'Perspective-origin x/y Control', 'dynamic-content-for-elementor' ),
			'type' => 'xy_positions',
			'responsive' => true,
			'condition' => [
				'transform_type' => 'custom',
