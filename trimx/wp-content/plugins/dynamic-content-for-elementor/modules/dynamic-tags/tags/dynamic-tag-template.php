...
class DCE_DynamicTag_Template extends Tag {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => '<a class="elementor-button elementor-button-block elementor-field-textual elementor-size-sm elementor-button-success" href="' . admin_url( 'edit.php?post_type=elementor_library#add_new' ) . '" target="_blank"><i class="eicon-plus"></i> ' . __( 'ADD NEW TEMPLATE', 'dynamic-content-for-elementor' ) . '</a>',
				'condition' => [
					'dce_template' => '',
				],
			]
		...
		$this->add_control(
			'dce_template_post_id',
			[
				'label' => __( 'Post', 'dynamic-content-for-elementor' ),
				'type' => 'ooo_query',
				'placeholder' => __( 'Force Post content', 'dynamic-content-for-elementor' ),
				'label_block' => true,
				'query_type' => 'posts',
				'condition' => [
					'dce_template!' => '',
		...
		$this->add_control(
			'dce_template_inline_css',
			[
				'label' => __( 'Inline CSS', 'dynamic-content-for-elementor' ),
		...
		$this->add_control(
			'dce_template_code',
			[
				'label' => __( 'Show shortcode', 'dynamic-content-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'condition' => [
					'dce_template!' => '',
				],
	...
	public function render() {
		...
		if ( ! empty( $settings['dce_template'] ) ) {
			...
			$template = \DynamicContentForElementor\Helper::get_dynamic_value( $template );
			echo $template;
		}
	}
