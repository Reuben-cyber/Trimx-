 ...
 * - Font Awesome PHP, Copyright (c) 2014 SMK-Toolkit, License: MIT, https://github.com/awps/font-awesome-php
 ...
 * - Moment.js, Copyright (c) Tim Wood, Iskren Chernev, Moment.js contributors, License: MIT, https://momentjs.com
...
function dce_admin_notice_minimum_elementor_version() {
	\DynamicContentForElementor\Notice::dce_admin_notice__warning( sprintf( __( 'Dynamic Content for Elementor requires Elementor version %1$s or greater', 'dynamic-content-for-elementor' ), DCE_MINIMUM_ELEMENTOR_VERSION ) );
}
