...
var Widget_DCE_Dynamicposts_gridtofullscreen3d_Handler = function($scope, $) {
  ...
  var postsItems = gridtofullscreen3d.find('.dce-post-item');

  var isGridtofullscreen3dEnabled = false;
  ...
  const transitionEffectDuration = elementSettings[DCE_dynposts_skinPrefix + 'gridtofullscreen3d_duration']['size'] || 1.8;
  const activationType = elementSettings[DCE_dynposts_skinPrefix + 'gridtofullscreen3d_activations'] || 'corners';
  ...
  eval('var settings_effect = ' + elementSettings[DCE_dynposts_skinPrefix + 'gridtofullscreen3d_effects'] + ';');
  ...
  const toggleFullview = () => {
    if (transitionEffect.isFullscreen) {
      ...
      if (elementSettings[DCE_dynposts_skinPrefix + 'gridtofullscreen3d_template']) {
