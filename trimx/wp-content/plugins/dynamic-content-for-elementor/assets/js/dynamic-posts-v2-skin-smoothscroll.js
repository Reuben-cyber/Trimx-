var Widget_DCE_Dynamicposts_smoothscroll_Handler = function ($scope, $) {
    ...
    var smoothscroll_image_perspective = elementSettings[DCE_dynposts_skinPrefix+'smoothscroll_image_perspective'];
    var smoothscroll_image_scale = elementSettings[DCE_dynposts_skinPrefix+'smoothscroll_image_scale'];
    var smoothscroll_image_translatey = elementSettings[DCE_dynposts_skinPrefix+'smoothscroll_image_translatey'];

    var smoothscroll_content_translatey = elementSettings[DCE_dynposts_skinPrefix+'smoothscroll_content_translatey'];

	// SMOOTHSCROLL
	var smooothscroll = $scope.find('.dce-posts-container.dce-skin-smoothscroll');
    var postsItems = smooothscroll.find('.dce-post-item');

    var isSmooothscrollEnabled = false;
