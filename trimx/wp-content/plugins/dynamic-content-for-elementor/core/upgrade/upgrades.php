...
class Upgrades {
	public static function _rename_tooltip_control( $element, $args ) {
		...
		$args['do_update'] = true;
		$changes = [
			'enable_tooltip' => 'dce_enable_tooltip',
			'tooltip_content' => 'dce_tooltip_content',
			'tooltip_arrow' => 'dce_tooltip_arrow',
			'tooltip_follow_cursor' => 'dce_tooltip_follow_cursor',
			'tooltip_max_width' => 'dce_tooltip_max_width',
			'tooltip_touch' => 'dce_tooltip_touch',
			'tooltip_background_color' => 'dce_tooltip_background_color',
	...
	public static function _v_1_15_0_dynamic_posts_v2_item_id( $updater ) {
		$changes = [
			[
				'callback' => [ 'DynamicContentForElementor\Core\Upgrade\Upgrades', '_dynamic_posts_v2_items' ],
				'control_ids' => [],
			],
		];
