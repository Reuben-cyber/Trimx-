...
class Notice {
	...
	public static function dce_admin_notice__license() {
		...
		<div class="error notice-error notice dce-generic-notice">
			...
			<?php printf( __( 'It seems that your copy is not activated, please %1$sactivate it%2$s or %3$sbuy a new license%4$s.', 'dynamic-content-for-elementor' ), '<a href="' . admin_url() . 'admin.php?page=dce-license">', '</a>', '<a href="https://www.dynamic.ooo/pricing" target="blank">', '</a>' ); ?></p>
		</div>
	<?php }
	}
