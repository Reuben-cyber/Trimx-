...
class Elements {
	...
	public function add_elementor_navigator( $admin_bar ) {
		...
		$admin_bar->add_menu(array(
			...
			'href' => $href,
			'meta' => array(
				'title' => __( 'Frontend Navigator', 'dynamic-content-for-elementor' ),
				'class' => 'menupop',
			),
		));
		Assets::dce_icon();
			...
			foreach ( $template_ids as $ekey => $id ) {
				...
				<li id="wp-admin-bar-elementor-template-edit-<?php echo $id; ?>">
					<a class="ab-item" href="<?php echo $edit_link; ?>" target="_blank">
						<span class="elementor-edit-link-title"><?php echo wp_kses_post( get_the_title( $id ) ); ?></span>
				<?php
		...
		<div id="elementor-navigator" style="display: none;">
			<div id="elementor-navigator__inner">
				<div id="elementor-navigator__header">
					...
					<div id="elementor-navigator__header__title"><i class="color-dce icon icon-dyn-logo-dce" style="color: #e52600;"></i> <?php _e( 'Navigator', 'dynamic-content-for-elementor' ); ?></div>
			...
			if ( is_array( $elementor_data ) ) {
				...
				foreach ( $elementor_data as $ekey => $evalue ) {
						...
						<div class="elementor-navigator__element__infobox">
							...
							<div class="elementor-navigator__element__infobox__body">
								...
								<div class="elementor-navigator__element__infobox__details">
									<div class="dce-title-h6"><?php _e( 'Details', 'dynamic-content-for-elementor' ); ?>:</div>
									<dl>
										<dt><?php _e( 'Name', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $name; ?></dd>
					<?php if ( ! empty( self::$elements_time[ $id ] ) && ! empty( self::$elements_time[ $id ]['start'] ) && ! empty( self::$elements_time[ $id ]['end'] ) ) { ?>
											<dt><?php _e( 'Time', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo self::$elements_time[ $id ]['end'] - self::$elements_time[ $id ]['start']; ?></dd>
					<?php } ?>
										<dt><?php _e( 'Element Count', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo self::$elements[ $type ][ $name ][ $id ]; ?></dd>
										<dt><?php _e( 'Type Count', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo count( self::$elements[ $type ][ $name ] ); ?></dd>
										<?php
										if ( $type == 'template' ) {
											$document = \Elementor\Plugin::$instance->documents->get( $id );
											if ( $document ) {
												?>
												<dt><?php _e( 'Type', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $document::get_title(); ?></dd>
												<?php if ( self::$user_can_elementor ) { ?>
													<dt><?php _e( 'Created on', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $document->get_post()->post_date; ?></dd>
													<dt><?php _e( 'Author', 'dynamic-content-for-elementor' ); ?></dt> <dd><a href="<?php echo \DynamicContentForElementor\Helper::get_user_link( $document->get_post()->post_author ); ?>" target="_blank"><?php echo get_the_author_meta( 'display_name', $document->get_post()->post_author ); ?></a></dd>
													<?php if ( $document->get_post()->post_date != $document->get_post()->post_modified ) { ?>
														<dt><?php _e( 'Modified on', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $document->get_post()->post_modified; ?></dd>
													<?php } ?>
														<?php
														...
														if ( $modified_author_id && $document->get_post()->post_author != $modified_author_id ) {
															?>
														<dt><?php _e( 'Modified by', 'dynamic-content-for-elementor' ); ?></dt>  <dd><a href="<?php echo \DynamicContentForElementor\Helper::get_user_link( $modified_author_id ); ?>" target="_blank"><?php echo get_the_author_meta( 'display_name', $modified_author_id ); ?></a></dd>
													<?php }
												} ?>
												<dt><?php _e( 'Status', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $document->get_post()->post_status; ?></dd>
												<?php
											}
										}
										$category = 'basic';
										if ( $type == 'widget' ) {
											...
											?>
											<dt><?php _e( 'Category', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo $category; ?></dd>
											<?php
										} else {
									...
									<div class="elementor-navigator__element__infobox__visibility">
										<div class="dce-title-h6"><i class="eicon-preview-medium"></i> <?php _e( 'Visibility', 'dynamic-content-for-elementor' ); ?>:</div>
										<dt>
											<?php if ( empty( self::$elements_hidden[ $id ] ) ) { ?>
											<dt><?php _e( 'Hidden', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php _e( 'Always', 'dynamic-content-for-elementor' ); ?></dd>
												<?php
											} else {
											...
											?>
										<dt><?php _e( 'Fallback', 'dynamic-content-for-elementor' ); ?></dt> <dd><?php echo empty( self::$elements_hidden[ $id ]['fallback'] ) ? __( 'No', 'dynamic-content-for-elementor' ) : __( 'Yes', 'dynamic-content-for-elementor' ); ?></dd>
										</dt>
									</div>
									<?php } ?>
						...
						if ( ! empty( $element_settings ) ) {
							?>
										...
										<a class="elementor-button elementor-button-warning elementor-size-xs elementor-navigator__element__infobox__edit" href="<?php echo $edit_link; ?>" target="_blank">
											<i class="eicon-pencil"></i> <?php _e( 'Edit', 'dynamic-content-for-elementor' ); ?>
										</a>
										<?php
					} else {
						if ( ! empty( $element_settings ) ) {
							?>
											<button class="elementor-button elementor-button-info elementor-size-xs elementor-navigator__element__infobox__copy" data-clipboard-action="copy" data-clipboard-target="#elementor-navigator__element__settings_<?php echo $id; ?>">
												<i class="eicon-copy"></i> <?php _e( 'Copy', 'dynamic-content-for-elementor' ); ?>
											</button>
											<?php
						}
					}
					...
					?>
								...
								<?php if ( $type == 'widget' ) { ?>
								<div class="elementor-align-center elementor-navigator__element__help"><a class="elementor-navigator__element__help__link" href="<?php echo $widget->get_custom_help_url() ? $widget->get_custom_help_url() : $widget->get_help_url(); ?>" target="_blank"><?php _e( 'Need Help', 'dynamic-content-for-elementor' ); ?> <i class="eicon-help-o"></i></a></div>
							<?php } ?>
						</div>
